...
if [ "$ROLE" = auditor ] && grep -qiE 'поломк|fault injection|арбитр|аудит тест' "$BRIEF"; then
  die "бриф упоминает поломки/fault injection/арбитров/аудит тестов, а роль запуска — обычный auditor.
