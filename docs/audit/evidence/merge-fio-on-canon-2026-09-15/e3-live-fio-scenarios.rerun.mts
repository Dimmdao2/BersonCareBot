...
const requireFromWebapp = createRequire(
  '/home/dev/dev-projects/bcb-wt-conflict-screens/apps/webapp/package.json',
);
const pg = requireFromWebapp('pg') as typeof import('pg');

const sourceRoot = '/home/dev/dev-projects/bcb-wt-conflict-screens/packages/platform-merge/src';
