...
const scheduleData: SlotsV1ScheduleData = {
  ...
  ...(newDayFilter === 'weekly_mask' && rawMerged.daysMask ? { daysMask: rawMerged.daysMask } : {}),
  ...(newDayFilter === 'every_n_days' && rawMerged.everyNDays
    ? {
        everyNDays: rawMerged.everyNDays,
        ...(rawMerged.anchorDate ? { anchorDate: rawMerged.anchorDate } : {}),
      }
    : {}),
};
```
