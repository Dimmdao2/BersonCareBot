...
>
> **Коррекция по свежему PROD-дампу 2026-08-15:** `518ea988…` нельзя называть пустой карточкой. Перед текущим
> hard-delete `consolidate-owner-identity.sql` переносит 133 appointment-ссылки (5 относятся к deleted history) и
> 7 service-availability строк (4 active), а также динамически проверяет остальные FK-классы.
