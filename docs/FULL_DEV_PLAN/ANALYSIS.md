...
| **react-markdown** + **remark-gfm** | Markdown-рендеринг (CMS, карточки) | MIT | Лёгкий, безопасный (нет XSS от HTML), достаточен для страниц и карточек клиентов |
...
6. **CMS контент** — решение: **Markdown** вместо WYSIWYG/HTML. Безопаснее (нет XSS), проще, достаточен для страниц и карточек клиентов. При необходимости можно добавить WYSIWYG позже.
