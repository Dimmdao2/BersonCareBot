...
- Вкладка **«Статистика»** (admin): `GET /api/admin/reminder-stats` — [`loadAdminReminderStats.ts`](../../apps/webapp/src/app-layer/stats/loadAdminReminderStats.ts), UI [`ReminderStatsSection.tsx`](../../apps/webapp/src/app/app/settings/ReminderStatsSection.tsx), `?adminTab=reminder-stats`.
