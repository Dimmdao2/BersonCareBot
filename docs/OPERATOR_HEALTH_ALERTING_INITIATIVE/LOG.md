...
- **Статистика:** `GET /api/admin/reminder-stats` — [`apps/webapp/src/app-layer/stats/loadAdminReminderStats.ts`](../../apps/webapp/src/app-layer/stats/loadAdminReminderStats.ts); UI [`ReminderStatsSection.tsx`](../../apps/webapp/src/app/app/settings/ReminderStatsSection.tsx), вкладка **`reminder-stats`** в [`AdminSettingsTabsClient.tsx`](../../apps/webapp/src/app/app/settings/AdminSettingsTabsClient.tsx). Контракт API — [`apps/webapp/src/app/api/api.md`](../../apps/webapp/src/app/api/api.md).
- **Тесты:** `apps/webapp/src/app/api/admin/reminder-stats/route.test.ts`; расширен `system-health/route.test.ts` (мок `adminReminderPipelineMetrics`).
