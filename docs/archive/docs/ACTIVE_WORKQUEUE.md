...
| **1** — «На сопровождении» + гейты comment/media                               | **Закрыта**                    | Cursor `phase1_support_model_7c745931.plan.md`; LOG: [`DOCTOR_PATIENT_CARD_TREATMENT_PROGRAM_INITIATIVE/LOG.md`](archive/legacy-underscore/DOCTOR_PATIENT_CARD_TREATMENT_PROGRAM_INITIATIVE/LOG.md) |
| **2A** — дизайн карточки врача                                                 | **Закрыта**                    | [`CARD_REDESIGN_PLAN.md`](archive/legacy-underscore/DOCTOR_PATIENT_CARD_TREATMENT_PROGRAM_INITIATIVE/CARD_REDESIGN_PLAN.md)                                                                         |
| **2B** — реализация карточки                                                   | **Закрыта**                    | LOG §2026-06-02                                                                                                                                                                    |
| **2C** — задачи специалиста                                                    | **Закрыта** (аудит 2026-06-02) | [`SPECIALIST_TASKS.md`](archive/legacy-underscore/DOCTOR_PATIENT_CARD_TREATMENT_PROGRAM_INITIATIVE/SPECIALIST_TASKS.md), LOG §2C                                                                    |
...
- ROADMAP_2 §2.2–2.3 — closed; план §фаза 5, `api.md`, targeted vitest — см. [`LOG.md`](archive/legacy-underscore/DOCTOR_PATIENT_CARD_TREATMENT_PROGRAM_INITIATIVE/LOG.md) §фаза 5.
...
- **Проверки:** vitest proactive + DoctorTodayDashboard + loadDoctorTodayDashboard; `tsc --noEmit` webapp. См. [`LOG.md`](archive/legacy-underscore/DOCTOR_PATIENT_CARD_TREATMENT_PROGRAM_INITIATIVE/LOG.md) §фаза 7.
...
План (архив): [`.cursor/plans/archive/instance-editor-batch-toolbar_3d597170.plan.md`](../.cursor/plans/archive/instance-editor-batch-toolbar_3d597170.plan.md). LOG: [`DOCTOR_PATIENT_CARD_TREATMENT_PROGRAM_INITIATIVE/LOG.md`](archive/legacy-underscore/DOCTOR_PATIENT_CARD_TREATMENT_PROGRAM_INITIATIVE/LOG.md) §2026-06-03 ф.7.
