...
- Полный `pnpm run ci` после каждого подблока не запускается; он нужен только для конкретного непокрытого интеграционного риска по [`AGENTS.md` §9](../../AGENTS.md#9-full-ci-gate), а не как барьер по факту push.
