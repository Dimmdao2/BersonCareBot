...
| Table / path                | Статус              | Примечание                                                |
| --------------------------- | ------------------- | --------------------------------------------------------- |
| message*threads, support*\* | **keep runtime**    | Ingest и runtime; product read — webapp.                  |
...
| Table / path                            | Статус              | Примечание                                           |
| --------------------------------------- | ------------------- | ---------------------------------------------------- |
| reminder\_\* tables, repos/reminders.ts | **keep runtime**    | Scheduling и runtime; product rules read — webapp.   |
...
| Table / path                  | Статус              | Примечание                                           |
| ----------------------------- | ------------------- | ---------------------------------------------------- |
| booking*records / rubitime*\* | **keep raw**        | Ingress и raw; product owner — webapp.               |
