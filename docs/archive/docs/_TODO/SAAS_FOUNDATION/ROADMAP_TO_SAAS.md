...
| `docs/archive/2026-08-initiatives/PRODUCT_PLATFORM_INITIATIVE/README.md` | deferred/cancelled for now              | Mass/patient mode and product-status resolver are not part of foundation; revisit after product lines and funnels exist.   |
