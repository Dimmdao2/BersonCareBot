...
- integrator: MIXED (repos do reads + writes to both integrator._ and public._ tables)
...
| pgClinicalTests.ts                 | A                       | MIXED | public.clinical\_\* (scoped)                                                            |
...
| pgTreatmentProgram.ts              | A                       | MIXED | public.treatment*program*\* (scoped)                                                    |
| pgTreatmentProgramItemSnapshot.ts  | A                       | READ  | public.treatment*program*\* (scoped)                                                    |
...
- _(Central pool definitions excluded: webapp `infra/db/client.ts`, integrator `infra/db/client.ts`.)_
...
| public.clinical\_\*                                         | `pgClinicalTests.ts`                                                                                                                 | webapp             | infra/repos                   |
...
| public.treatment*program*\*                                 | `pgTreatmentProgram.ts`                                                                                                              | webapp             | infra/repos                   |
