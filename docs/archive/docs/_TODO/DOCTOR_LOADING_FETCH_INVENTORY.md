...
**Still partial:** full Chromium entitlement matrix (DL-RUNTIME-01). **Safari:** `[x]` owner soak §11. **FCP P0:** `[x]` code done §10 (chat/LFK/home FC/schedule FC host); re-measure gzip on TEST pending.
