...
| `SAAS_FOUNDATION/TRACK_D1_APPROACH_DECISION_2026-07-24.md` | 7 | 0 | 0 | **ЗАМЕНЁН 02.09** | Более поздняя реализация и owner-решения сведены в `DB_PRIVILEGE_LAYER_REBUILD/PLAN.md`; старые боксы не переоткрывают Track D. | `docs/archive/2026-07-track-d/SAAS_FOUNDATION/` |
