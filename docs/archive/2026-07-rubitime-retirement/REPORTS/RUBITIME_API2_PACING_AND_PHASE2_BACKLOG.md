# АРХИВ — Rubitime API2: глобальный pacing (фаза 1) и backlog фазы 2

> Rubitime выведено из эксплуатации 2026-07-27. Это исторический отчёт; описанная фаза 2 не является активным backlog.
...
- Пайплайн бронирования Rubitime: `docs/archive/2026-07-rubitime-retirement/ARCHITECTURE/RUBITIME_BOOKING_PIPELINE.md` (в т.ч. post-create projection и ссылка на pacing/throttle).
