...
- Documentation update in `docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/LOG.md` after EXEC/FIX.
...
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/FILTER_URL_CONTRACT_FIX_PLAN.md
...
8. Прогони таргетные проверки:
   ...
   - `pnpm --dir apps/webapp exec vitest run <targeted-test-files>`
   - `pnpm --dir apps/webapp exec tsc --noEmit`
9. Обнови `docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/LOG.md` с решениями, изменёнными файлами, проверками и residual risks.
...
Сохрани результат в:
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_FILTER_URL_CONTRACT_FIX.md
...
6. Прогони таргетные проверки:
   ...
   - `pnpm --dir apps/webapp exec tsc --noEmit`
7. Обнови:
   - `docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_FILTER_URL_CONTRACT_FIX.md` с fix verification.
   - `docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/LOG.md` с результатами FIX и проверками.
