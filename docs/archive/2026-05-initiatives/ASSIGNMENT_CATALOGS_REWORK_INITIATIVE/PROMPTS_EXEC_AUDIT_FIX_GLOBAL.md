...
- `docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/README.md`
- `docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/MASTER_PLAN.md` (в т.ч. **§9 Git / CI**)
- `docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/PRE_IMPLEMENTATION_DECISIONS.md`
- `docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/STAGE_B1_PLAN.md` … `STAGE_B7_PLAN.md`
- `docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/LOG.md`
- `docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/LOG_TEMPLATE.md`
- `docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/EXECUTION_AUDIT_TEMPLATE.md`
- `docs/APP_RESTRUCTURE_INITIATIVE/ASSIGNMENT_CATALOGS_REWORK_PLAN.md`

Файлы аудитов (создаются по мере прохождения):

- `docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_STAGE_B1.md`
- … `AUDIT_STAGE_B7.md`
...
9. После каждого EXEC/FIX обновлять `docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/LOG.md` по `LOG_TEMPLATE.md`.
...
Вход:
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/STAGE_B1_PLAN.md
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/MASTER_PLAN.md §9
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/PRE_IMPLEMENTATION_DECISIONS.md
...
Сохрани: docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_STAGE_B1.md
...
```text
Выполни FIX по docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_STAGE_B1.md.
...
Вход:
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/STAGE_B3_PLAN.md
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/PRE_IMPLEMENTATION_DECISIONS.md (Q5)
...
Сохрани: docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_STAGE_B3.md
Добавь MANDATORY FIX INSTRUCTIONS (critical/major/minor).
```
...
```text
Выполни FIX по docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_STAGE_B3.md.
...
Вход:
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/STAGE_B4_PLAN.md
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/PRE_IMPLEMENTATION_DECISIONS.md (Q3/Q4: колонка `domain`, UI «Тип»; без merge legacy в одной миграции)
...
Сохрани: docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_STAGE_B4.md
Добавь MANDATORY FIX INSTRUCTIONS (critical/major/minor).
```
...
```text
Выполни FIX по docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_STAGE_B4.md.
...
Вход:
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/STAGE_B5_PLAN.md
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/PRE_IMPLEMENTATION_DECISIONS.md
...
Сохрани: docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_STAGE_B5.md
Добавь MANDATORY FIX INSTRUCTIONS (critical/major/minor).
```
...
```text
Выполни FIX по docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_STAGE_B5.md.
...
Вход:
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/STAGE_B6_PLAN.md
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/PRE_IMPLEMENTATION_DECISIONS.md (pre-check после фазы A)
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/MASTER_PLAN.md §9
...
Сохрани: docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_STAGE_B6.md
Добавь MANDATORY FIX INSTRUCTIONS (critical/major/minor).
```
...
```text
Выполни FIX по docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_STAGE_B6.md.
...
Вход:
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/STAGE_B7_PLAN.md
- docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/PRE_IMPLEMENTATION_DECISIONS.md (в т.ч. local_comment на lfk_complex_exercises)
...
Сохрани: docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_STAGE_B7.md
Добавь MANDATORY FIX INSTRUCTIONS (critical/major/minor).
```
...
```text
Выполни FIX по docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_STAGE_B7.md.
...
Сохрани: docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_GLOBAL.md
```
...
Сохрани: docs/archive/2026-05-initiatives/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/AUDIT_PREPUSH_POSTFIX.md
```
