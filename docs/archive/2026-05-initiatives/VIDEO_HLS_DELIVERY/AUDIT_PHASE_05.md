...
- Подтверждение «**реально играет**» на конкретных сборках Chrome/Safari — **чеклист** `docs/archive/2026-05-initiatives/VIDEO_HLS_DELIVERY/BROWSER_SMOKE_PHASE05_CHECKLIST.md` (заполняет ops перед первой раскаткой HLS по умолчанию).
