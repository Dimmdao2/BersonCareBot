...
**Статус:** завершена и заархивирована (2026-05-01); продуктовый gate закрыт принятием текущего состояния.
...
Базовая витрина уже реализована и закрыта в [`../PATIENT_HOME_REDESIGN_INITIATIVE/README.md`](../PATIENT_HOME_REDESIGN_INITIATIVE/README.md). Текущая проблема в другом: редактору неудобно наполнять блоки, создавать недостающие разделы, понимать почему блок не виден на главной, и безопасно менять slug разделов.
