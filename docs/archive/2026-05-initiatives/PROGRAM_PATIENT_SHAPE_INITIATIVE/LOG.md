...
**Scope (подтверждение):** изменения только в **`apps/webapp/src/modules/treatment-program/instance-service.ts`**, **`docs/archive/2026-05-initiatives/PROGRAM_PATIENT_SHAPE_INITIATIVE/AUDIT_STAGE_A3.md`**, **`LOG.md`** — внутри treatment-program домена + initiative docs; без courses, без новых API/env, без DnD.
...
- `docs/archive/2026-05-initiatives/PROGRAM_PATIENT_SHAPE_INITIATIVE/STAGE_A1_PLAN.md` §6 — все пункты `[x]`.
- `docs/archive/2026-05-initiatives/PROGRAM_PATIENT_SHAPE_INITIATIVE/AUDIT_STAGE_A1.md` §4 — статусы закрытия minor + блок Post-FIX.
...
- `docs/archive/2026-05-initiatives/PROGRAM_PATIENT_SHAPE_INITIATIVE/STAGE_A1_PLAN.md` — явная фиксация O1 в §2.
...
- Создана папка `docs/PROGRAM_PATIENT_SHAPE_INITIATIVE` (позже перенесена в `docs/archive/2026-05-initiatives/PROGRAM_PATIENT_SHAPE_INITIATIVE/`).
