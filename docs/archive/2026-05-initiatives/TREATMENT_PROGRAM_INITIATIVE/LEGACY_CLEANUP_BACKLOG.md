...
## A. modules/_ — прямой доступ к `@/infra/db/_`, `@/infra/repos/\*`(27 production-файлов;`patient-home`legacy news/mailing/quote вынесены в infra + DI, см.`GLOBALFIX` 2026-04-29)
