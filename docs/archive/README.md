...
## 2026-08 — закрытые папки `docs/*_INITIATIVE/`

По указанию владельца 2026-08-19: [`2026-08-initiatives/README.md`](2026-08-initiatives/README.md) — product analytics, product platform (deferred), communications MD v2, online-consult rehab/nutrition (отменена).

## 2026-08 — консолидация инфраструктурной безопасности

Прежние планы `INFRA-01`, `CRYPTO-01`, `DR-01/02`, `SEC-01`, `SEC-02` и инфраструктурная часть `SEC-04`
сохранены с картой переноса в
...
сохранением исходного пути. Индекс с вердиктом и основанием по каждому — [`2026-07-plans/README.md`](2026-07-plans/README.md).
Живых чекбоксов среди перенесённого нет: файл с хотя бы одним `- [ ]` в архив не пускал гейт, и семь
кандидатов он не пустил — они остались в `docs/_TODO/`.

## legacy-underscore

`legacy-underscore/` содержит 12 каталогов, перенесённых 2026-07-29 из прежнего underscore-корня архива с сохранением имён и git-истории. `docs/archive/` теперь единственный корень архива.
...
| `telegram_execution_audit.md`          | Статус экшенов и скриптов (EXECUTABLE*NOW / BLOCKED*\*).                            |
