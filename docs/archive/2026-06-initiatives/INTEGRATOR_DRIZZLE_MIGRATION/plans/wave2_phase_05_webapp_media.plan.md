...
- **Исключения (документировано):** `client.query("BEGIN"|"COMMIT"|"ROLLBACK")` на PoolClient; `collectAdminSystemHealthData` / `adminTranscodeHealthMetrics` — без изменений SQL; transcode **claim** — **P8 done** (`apps/media-worker/src/jobs/claim.test.ts`); **`processTranscodeJob`** — фаза **IX**.
...
- **Документация:** [LOG.md](../../../../INTEGRATOR_DRIZZLE_MIGRATION/LOG.md) § Wave 2 этап 5; [RAW_SQL_INVENTORY.md](../../../../INTEGRATOR_DRIZZLE_MIGRATION/RAW_SQL_INVENTORY.md) — P5 done для медиа repos/routes §2.4–2.5; [plans/README.md](./README.md), [DRIZZLE_TRANSITION_PLAN.md](../../../../INTEGRATOR_DRIZZLE_MIGRATION/DRIZZLE_TRANSITION_PLAN.md).
- **Проверки (воспроизводимые):**
  ...
  - P5 vitest bundle (список файлов — § этап 5 в [LOG.md](../../../../INTEGRATOR_DRIZZLE_MIGRATION/LOG.md))
  - `pnpm run ci`
