...
Врач видит кнопку «Назначить комплекс ЛФК» рядом с кнопкой «Назначить программу». В целевой доменной модели ЛФК-комплекс — это _элемент этапа_ в программе лечения, а не самостоятельное назначение.
