# Native mobile app initiative — archived local-bundle direction

> **АРХИВ / SUPERSEDED 2026-09-09.** Владелец отменил эту архитектуру и поручил реализовать два тонких
> Android/Capacitor-приложения поверх действующего Next.js, сохранив PWA для iOS/Android. Ни один открытый пункт
> этой папки не исполняется. Текущий authority:
