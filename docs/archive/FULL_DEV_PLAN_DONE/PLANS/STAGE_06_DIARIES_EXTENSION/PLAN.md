...
_Документ обновлён: микрошаги для режима «авто», исправлена нумерация миграций относительно текущего репозитория (`022+`), добавлены границы ответственности и обязательные проверки._
