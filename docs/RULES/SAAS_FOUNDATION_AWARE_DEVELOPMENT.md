...
Если ownership неочевиден, нельзя молча добавлять unscoped таблицу/поле. Нужно остановить этот подпункт, пометить его как `needs_decision` в плане/taskdb note и оставить короткий design note для dev-lead/владельца.
