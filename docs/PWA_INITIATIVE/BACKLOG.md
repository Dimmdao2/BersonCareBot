...
| Задача | Примечание |
|--------|------------|
| ~~**Фаза 5 — Staff PWA + блок чужих зон**~~ | **done** 2026-06-07 — [`DOCTOR_PATIENT_PWA_SPLIT_INITIATIVE`](../DOCTOR_PATIENT_PWA_SPLIT_INITIATIVE/README.md) волна 2 ([`WAVE2_STAFF_PWA.md`](../DOCTOR_PATIENT_PWA_SPLIT_INITIATIVE/WAVE2_STAFF_PWA.md), [`ACCEPTANCE_WAVE2.md`](../DOCTOR_PATIENT_PWA_SPLIT_INITIATIVE/ACCEPTANCE_WAVE2.md)). |
...
Фаза 5 (Staff PWA) снята с backlog — реализована в DOCTOR_PATIENT_PWA_SPLIT волна 2.
