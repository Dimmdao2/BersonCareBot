...
Инициатива: установляемое веб‑приложение на базе `apps/webapp` (manifest, **публичный** лендинг **`/`**, установка, минимальный SW вне Mini App), без дублирования пакета. Исторический снимок стека — [`BASELINE_STRUCTURE.md`](BASELINE_STRUCTURE.md); операторский чеклист после деплоя — [`PHASE_00`](PHASE_00_PRINCIPLES_AND_SCOPE.md) («Верификация на стенде»).
