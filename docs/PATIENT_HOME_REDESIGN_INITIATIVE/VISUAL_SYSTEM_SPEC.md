...
| Bottom nav | `apps/webapp/src/shared/ui/PatientBottomNav.tsx` | `fixed bottom`, контейнер `max-w-[480px] lg:max-w-6xl`, виден всегда | размеры/цвета по spec; скрывать `lg+` (desktop), оставлять `< lg` (mobile/tablet) |
