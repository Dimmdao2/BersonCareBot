...
> Чтобы агенты не создавали расходящиеся копии, решения владельца из review 2026-07-18 поддерживаются в едином
> owner-review, а этот технический план ссылается на них и перерабатывается при начале implementation. Владелец
> в любой момент может изменить структуру документов или дать новое решение.
