...
1. В MAX откройте чат с ботом и отправьте `/start` или нажмите «Главное меню».
2. Должно прийти сообщение с inline-меню (Скорая помощь, Персональный помощник, Полезные уроки, Мои записи, Настройка уведомлений).
