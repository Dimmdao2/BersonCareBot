...
| **15** | **In progress** (15A–15B done) | [Webapp long tail](./plans/wave3_phase_15_webapp_long_tail.plan.md) — **15A** refs/settings/diary + **15B** auth/email ports (**0** raw SQL в scope); **15C–15F** pending (treatment, push outbox, messenger bind, verify) |
