...
| **15** | **In progress** (15A–15D done) | [Webapp long tail](./plans/wave3_phase_15_webapp_long_tail.plan.md) — **15A–15D** done (**0** `db.query` в `integratorPushOutbox`); **15E–15F** pending (messenger bind, verify) |
