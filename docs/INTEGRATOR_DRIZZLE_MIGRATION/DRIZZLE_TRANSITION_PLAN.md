...
| **14** | **Done** | [Comms / projection](./plans/wave3_phase_14_webapp_comms_projection.plan.md) — support comms, user projection, admin audit, comms tail; Zod query modules; `pool.query` = 0 по 11 scope-файлам; Vitest **118 passed** / 11 skipped + opt-in devDb smokes |
| **15** | Pending | [Webapp long tail](./plans/wave3_phase_15_webapp_long_tail.plan.md) — references, auth/email, treatment tails, integrator push outbox, messenger bind |
