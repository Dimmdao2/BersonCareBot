...
**Дата сборки:** 2026-05-05 (доп. 2026-06-02 — очередь фаз 3–4).  
**Статус Этап 2 (назначение из карточки):** ✅ завершён 2026-05-05 — см. [`MASTER_PLAN.md`](MASTER_PLAN.md) и [`LOG.md`](LOG.md).  
**Операционная очередь (фазы 0–6):** [`docs/ACTIVE_WORKQUEUE.md`](../ACTIVE_WORKQUEUE.md) — **закрыта** 2026-06-02 (включая фазу 6 CMS/`/help`); хвосты — [`docs/TODO.md`](../TODO.md).
...
**Закрыто owner 2026-06-01:**

- **O5** — срок этапа (`expected_duration_*`) **не обязателен**.
- **O6** — persistent-рекомендации после завершения программы → **история**; в активной программе пациент видит **общее промо**.
- **O7** — UX истории попыток теста → **TODO** после доработки элементов тестов ([`docs/TODO.md`](../../TODO.md)).
...
**Что осталось:** ~~ручной smoke~~ ✅ owner 2026-06-01. Дальнейший контур карточки — [`docs/TODO.md`](../../TODO.md) §Doctor card.
...
- Кросс-пациентский inbox на «Сегодня» — **✅ закрыт** (active workqueue **фаза 5**, 2026-06-02): `DoctorTodayPendingProgramTestsSection`, `focusItemId`, бейдж «Сегодня»; см. [`LOG.md`](LOG.md) §фаза 5, [`ROADMAP_2.md`](../APP_RESTRUCTURE_INITIATIVE/ROADMAP_2.md) §2.2–2.3.
