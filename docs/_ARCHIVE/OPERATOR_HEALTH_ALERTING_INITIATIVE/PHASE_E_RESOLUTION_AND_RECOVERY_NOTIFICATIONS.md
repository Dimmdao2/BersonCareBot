...
> **Статус: superseded (2026-06-09).** Отдельный push «восстановлено» **не** реализуем. Recovery — только строка в утренней/вечерней сводке ([`ROADMAP_WAVE2.md`](ROADMAP_WAVE2.md) волна 2–3, [`SCOPE_DECISIONS.md`](SCOPE_DECISIONS.md) P1). Документ сохранён как историческая декомпозиция.
