...
- [ ] снять селектор пояса из профиля пациента; определение устройством (`PatientCalendarTimezoneBootstrap`)
      остаётся — оно и есть правильный путь по §34;
- [ ] то же у специалиста и админа, если контрол там есть;
- [ ] вывести поле пояса у ФИЛИАЛА — это находка №1 переписи тихого кода `SILENT_CODE_CENSUS_2026-08-19.md`
