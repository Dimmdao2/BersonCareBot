...
- `git diff --check -- apps/webapp/db/drizzle-migrations/20260821T050000_add_vk_messenger_settings.sql` -> clean.

No DB access, named-DEV preflight, migration execute/reapply, fixtures, disposable DB, historical replay,
TEST/PROD, landing, deploy, push or full CI were performed.
