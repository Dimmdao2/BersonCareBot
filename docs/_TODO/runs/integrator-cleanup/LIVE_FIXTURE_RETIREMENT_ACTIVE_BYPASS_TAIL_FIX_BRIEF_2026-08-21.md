...
Источник оракула: `docs/_TODO/NIGHT_WAVE_AUDIT_QUEUE_2026-07-28.md` строка fixture retirement — «Candidate removes persistent fixture/seed/reconcile/deploy-gate machinery and DB-writing DEV bypass ports, then normalizes active fixtures, D15b/6, D30 and HTTP owner decisions».
