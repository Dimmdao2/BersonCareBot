...
## Как выполнять — добавлено 2026-08-03 после первой неудачной попытки

⛔ **Исследование пишешь ТЫ, в этом же прогоне.** Первый запуск закончился ничем: агент делегировал работу
фоновому воркфлоу и завершился, а фоновый процесс умер вместе с ним, не оставив ни документа, ни следа.

- Не запускай фоновые воркфлоу, демоны и отложенные прогоны. Всё делается внутри твоего хода.
- Ищи источники сам (веб-поиск), читай их сам, пиши документ сам.
- Ход считается завершённым только когда файл
  `docs/_TODO/runs/integrator-cleanup/IDENTITY_DB_SPLIT_RESEARCH_2026-08-03.md` существует, заполнен и
  закоммичен. Отчёт без файла — незавершённая работа.
- Если объём не помещается, лучше сократи глубину по каждому вопросу, но закрой все шесть и доведи документ до
  коммита.
