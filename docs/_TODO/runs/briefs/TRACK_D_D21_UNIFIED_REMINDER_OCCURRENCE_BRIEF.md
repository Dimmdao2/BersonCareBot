...
Единственный канон исполнения: `AGENTS.md`, особенно §5, §7, §9–§10 и §24.

Источник оракула: Р-D21 — «У нас есть напоминалки о разминках и о тренировках, все они в вебапп.
Напоминалки про это из бота — убираем как самостоятельную историю и оставляем как часть общей системы,
которая настраивается в одном месте — а отправляется туда куда выбрал пользователь»; D21 — «накопленные
