...
Источник оракула: `docs/_TODO/SAAS_FOUNDATION/SAAS_BILLING_PLAN.md` B1.1 — «Одна дверь оплаты, у которой обязательные поля: кто платит, за что, сколько, куда вернуть».
