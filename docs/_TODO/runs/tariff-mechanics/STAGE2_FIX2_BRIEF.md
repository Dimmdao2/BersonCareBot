...
Owner ruling 30.07, verbatim: «конечно отключаются и оплаты и брендирование [владелец 30.07 поправил свою же оговорку: в исходном сообщении было «и лестницы», имелось в виду «брендирование»], но мы вернулись к началу — ты вместо того чтобы
