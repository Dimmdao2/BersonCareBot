...
| [`STABILITY_SECURITY_HARDENING_PLAN_2026-07-21.md`](../STABILITY_SECURITY_HARDENING_PLAN_2026-07-21.md) | open | C1 repository dark-launch исполняется как `#969` и использует `0230`; D1 `#970` ждёт TTL/admin/SLA ruling; D2 source census/atomic contract закрыт `#973`, implementation ещё не начат; E2/E3 открыты. Host activation и A4/A2/E1/post-launch residual идут только по собственным gates. |
