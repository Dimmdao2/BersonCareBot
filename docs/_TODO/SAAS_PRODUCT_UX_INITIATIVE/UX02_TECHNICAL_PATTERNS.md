...
- [`REQUIREMENTS.md`](REQUIREMENTS.md) и [`ROADMAP.md`](../../archive/2026-07-plans/SAAS_PRODUCT_UX_INITIATIVE/ROADMAP.md);
...
- исторический, но реализованный [`STAFF_PWA_ADR.md`](../../archive/legacy-underscore/DOCTOR_PATIENT_PWA_SPLIT_INITIATIVE/STAFF_PWA_ADR.md).
