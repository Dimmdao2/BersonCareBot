...
- **Решение владельца:** платное полное брендирование работает на собственном домене организации либо platform
  ...
  Per-clinic layout/theme/design customization не планируется. Вне paid branded org surface staff/admin identity —
  Therapysto, standard patient identity — Therapygo. Решение не обещает видимый Therapysto/Therapygo внутри fully branded surface; exact legal/support/
...
- **Варианты:**
  1. Public/booking/join/patient surfaces — organization-first; staff остаётся узнаваемым Therapysto workspace с org
