...
| —   | [`DOCTOR_DNA_MIGRATION/`](DOCTOR_DNA_MIGRATION/PLAN.md) — owner-controlled doctor UI design migration                                                                        | **ACTIVE owner-review contour (`#885`)**                                                        | не заменяет Product UX roadmap                              |
