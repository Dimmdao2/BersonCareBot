...
**NOT DONE:** populated live Today-support and Messages rows are still needed to seal primary typography,
whole-row hover/divider and selected Messages state. The mobile menu must be opened in a live capture to seal its
