...
- [ ] **D10b — уборка и возврат зависших в очереди доставки.** Найдено 30.07 на dev: уборки нет вообще (строки со
...
- [ ] **D10c — постановка отложенного принимает абсолютное время, а не только задержку в секундах.** Сейчас вход один:
