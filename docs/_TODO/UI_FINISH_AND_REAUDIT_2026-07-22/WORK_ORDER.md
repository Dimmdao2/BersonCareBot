...
- [ ] **E2 — кнопка «отписаться от темы».** _Код приземлён 22.08 (`7e2943fc9`), галочка ждёт живой
      проверки на TEST — «готово» это план + зелёный full CI + живой прогон, а не отчёт исполнителя._ По решению **Р-E2** (§2.5): в каждом письме рассылки и рассылочном
