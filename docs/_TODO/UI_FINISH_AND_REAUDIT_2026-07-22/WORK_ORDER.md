...
- [ ] **D35 — у каждого переключателя админки есть потребитель, и потребитель один** (передано из #1081,
...
- [ ] **D33 — постановка повторов доставки идёт мимо общей очереди в двух местах.** Вставка в
