...
- **Р-E2 (владелец, 31.07), действует.** Кнопка «отписаться от темы» — в каждом письме рассылки и в каждом
  ...
  отдельный экран знакомства. **Решение владельца 22.08.2026:** служебные сообщения (код входа, подтверждение
  почты, напоминание о приёме, ответ на действие человека) кнопку не получают; отписка относится только к
  рассылкам. → чек-лист Track E, пункт E2.
...
- [x] **E2 — кнопка «отписаться от темы».** По решению **Р-E2** (§2.5): в каждом письме рассылки и рассылочном
