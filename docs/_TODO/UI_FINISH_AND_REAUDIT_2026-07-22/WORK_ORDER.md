...
- **A1. OWNER CORRECTION 2026-08-25.** Общий фон всех страниц — точно `#f2f2f0` через `--bc-canvas` и зональные
  проекции; page header и основные поверхности остаются белыми. Все кнопки/button-like controls имеют радиус
  ровно `8px`; doctor input/select trigger сохраняют `24px`.
