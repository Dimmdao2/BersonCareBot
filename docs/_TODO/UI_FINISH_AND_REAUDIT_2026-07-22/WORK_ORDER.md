...
- [ ] **D35 — политика отказа доставки: закрыть служебный ответ, а не оставлять его только в логе.** Решение и
...
- [ ] **D24 — три недостижимых действия по правилам напоминаний.** Решение — **Р-D24** (§2.3): проверить, что
