...
- [ ] **A4. Первый запуск и график «Сегодня», owner-report 25.08.2026.** Владелец: «При первом входе: все еще
      ...
      показывает неотменённые записи из фактического календарного фида TEST.
