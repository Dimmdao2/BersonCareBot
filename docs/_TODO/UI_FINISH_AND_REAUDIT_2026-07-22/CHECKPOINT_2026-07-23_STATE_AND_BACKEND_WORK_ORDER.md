...
**Границы (неизменны):** этот бокс = DEV + TEST. Прод (135.x) вне scope. Не пушить в `main`/`test`, не гнать
prod-миграции. Всё разрушающее и все юридические гейты — owner-gated.
