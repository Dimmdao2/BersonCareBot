...
- **LIVE-STAFF-WORKSPACE-RESOLVE-001 — ИСПРАВЛЕНО В КОДЕ, LIVE-ПОДТВЕРЖДЕНИЕ ОТКРЫТО:** реальный вход врача
  ...
  platform user. Unit `10/10`, exact catalog/callsite `18/18`, typecheck/lint и generated byte-check зелёные.
  Finding закрывается только повторным DEV cutover и живой страницей врача/clinic-admin.
