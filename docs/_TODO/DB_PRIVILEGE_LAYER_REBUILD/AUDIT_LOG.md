...
- **LIVE-PATIENT-COMPOSITION-001 — ИСПРАВЛЕНО В КОДЕ, ПОЛНАЯ СТРАНИЦА ЕЩЁ В ОБЩЕЙ МАТРИЦЕ:** первый живой
  ...
  чтения auth-channel policy и повторно прошёл эту точку; новой сущности/доступа не добавлено. Полный response
  кабинета проверяется вместе с остальными страницами после следующего cutover.
- **LIVE-STAFF-WORKSPACE-RESOLVE-001 — ИСПРАВЛЕНО В КОДЕ, LIVE-ПОДТВЕРЖДЕНИЕ ОТКРЫТО:** реальный вход врача
  ...
  Unit `10/10`, exact catalog/callsite `18/18`, оба typecheck и generated byte-check зелёные. Finding закрывается
  только повторным DEV cutover, применением fixture и живой страницей врача/clinic-admin.
- **LIVE-COMMERCE-TRIAL-WILDCARD-001 — ИСПРАВЛЕНО В ДЕКЛАРАЦИИ, LIVE-ПОДТВЕРЖДЕНИЕ ОТКРЫТО:** после устранения
  ...
  byte-check зелёные. Finding закрывается повторным apply и отсутствием этого отказа в живом DEV-журнале.
