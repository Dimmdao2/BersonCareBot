...
- [ ] `public.appointment_records` и оставшиеся production-callers старой записи удалить отдельно; живые
      операции должны идти через `public.be_appointments`, а restore+delta должен воспроизводимо удалить таблицу
