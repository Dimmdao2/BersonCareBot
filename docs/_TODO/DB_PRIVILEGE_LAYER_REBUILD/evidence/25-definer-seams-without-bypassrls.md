...
| `retired pre-B0 disposable harness (Git history only):569-571` | real clusters всегда имеют `app_owner BYPASSRLS` | fixture creates requested seam owners/policies; не один всемогущий owner |
