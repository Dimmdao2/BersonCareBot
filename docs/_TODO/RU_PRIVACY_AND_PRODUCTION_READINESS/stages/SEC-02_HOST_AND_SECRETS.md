...
> **⚠️ Требует подтверждения владельца (2026-07-27).** Владелец 27.07 сказал про SSH-root/пароли и службы от
> root: «это только на тесте... На проде не будет». Снимок `CURRENT_PROD_BASELINE_2026-07-19.md` снят с хоста
