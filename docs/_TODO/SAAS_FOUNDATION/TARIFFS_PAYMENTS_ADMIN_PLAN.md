...
- [ ] **2.6** Зашитых констант не остаётся: любая длительность, порог и конечное состояние — значение поля, а не
      число в коде. Механическая проверка: в коде нет длительностей и конечных состояний, выбранных агентом.
- [ ] **2.6a** Снять агентские константы, которые сегодня решают за владельца. Действующие требования:
