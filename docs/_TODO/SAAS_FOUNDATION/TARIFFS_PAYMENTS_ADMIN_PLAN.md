...
- [ ] **5.2** Число пациентов: само число + две ручки (см. §5 канона). Поведение при неоплате и при понижении
...
- [ ] **5.3** Число филиалов: число + две ручки, значения ставит владелец.
- [ ] **5.4** Объём файлов в байтах: атомарная проверка суммы при загрузке + две ручки. Значение владельца по
