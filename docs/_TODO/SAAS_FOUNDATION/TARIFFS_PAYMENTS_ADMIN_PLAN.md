...
> (`docs/_TODO/SAAS_FOUNDATION/AUDIT_TARIFF_DOWNGRADE_CAPABILITY_2026-09-02.md`). Остаток строки (regression
> sweep Phase 2, `4a.6`/`7.3`/`7.4`) не тронут.
...
- [ ] **4b.3** ⛔ **ОТКРЫТО ОБРАТНО 02.09 независимым аудитом — FAIL, приземлять нельзя**
      ...
      Ниже — исходная запись исполнителя, оставлена как есть:
...
- [ ] **4b.4** ⛔ **ОТКРЫТО ОБРАТНО 02.09 независимым аудитом** — тем же изменением, что и 4b.3, поэтому
      ...
      исправленной миграции). Ниже — исходная запись исполнителя, оставлена как есть:
