...
- [ ] **Т5. Выбор тарифа и срок триала — ДВЕ независимые настройки.** Отдельно настраивается, даём ли мы человеку
...
- [ ] **Т6. Льготный период — отдельная опция поверх правила «После триала».** Нынешние варианты
...
- [ ] **Т8. Как задаётся скидка.** Владелец назвал два варианта — процент со скидкой и округлением, либо точная
