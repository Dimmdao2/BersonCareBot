...
- [ ] **2.6a** Снять агентские константы, которые сегодня решают за владельца (список — аудит Opus 30.07, раздел B):
      ...
      **⚠️ ВЛАДЕЛЕЦ ОТВЕТИЛ ПО КАЖДОЙ 31.07 — читать это, а не формулировки выше:**
      ...
      · **порог предупреждения** — константы 80% нет; поле `includedSeatsWarningAtPercent` настраивается владельцем
        и считается от числа включённых МЕСТ СПЕЦИАЛИСТОВ. У пациентов, филиалов и объёма порога нет вовсе.
