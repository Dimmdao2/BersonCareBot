...
if (tierRows.length !== 227) {
  fail(`Expected 227 tier rows, got ${tierRows.length}`);
}
...
console.log("P0.8.1 RLS descriptor model OK: 227 descriptors cover tiers-218.tsv exactly once.");
console.log(
