...
export function assertP083PublicDirectOrgTargets(targets) {
  ...
  if (actualTables.length !== 109) {
    throw new Error(`Expected 109 P0.8.3 public direct-org targets, got ${actualTables.length}`);
  }
...
export function renderP083PolicyStatements({ descriptors = getP083PublicDirectOrgDescriptors() } = {}) {
