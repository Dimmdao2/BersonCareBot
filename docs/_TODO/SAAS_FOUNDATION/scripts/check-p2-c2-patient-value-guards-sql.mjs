...
requireFragments(`${opsSqlPath} channel preference ownership parity`, executableSql, [
...
requireFragments(`${channelPreferencesRepoPath} ownership predicate`, channelPreferencesRepo, [
