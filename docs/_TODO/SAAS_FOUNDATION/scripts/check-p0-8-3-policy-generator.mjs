...
assert.equal(targets.length, 109, "P0.8.3 must target exactly 109 public direct-org tables");
...
console.log(
  `P0.8.3 policy generator OK: 109 targets (${patientOwnedDescriptors.length} patient-owned, ${patientChainOwnedDescriptors.length} patient-chain-owned, ${patientConditionalOwnedDescriptors.length} patient-conditional-owned) and deterministic dormant policy DDL.`,
);
