...
- `docs/_TODO/SAAS_FOUNDATION/RUBITIME_RETIREMENT_R1_STALE_CSV_PROOF.md` is aggregate-only and PII-safe for the audited scope.
...
```bash
ls -l docs/_TODO/SAAS_FOUNDATION/RUBITIME_RETIREMENT_EXECUTION_PLAN.md \
