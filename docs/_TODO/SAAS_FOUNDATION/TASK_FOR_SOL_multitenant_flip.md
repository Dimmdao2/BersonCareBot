...
(а) деплой подмножества миграций 0160-0175 vs полный #667-чейн; (б) замена role-membership 0175 (#662) на
GUC-`is_staff`. Оба — часть выбранного пути; подтвердить перед прод-cutover.
