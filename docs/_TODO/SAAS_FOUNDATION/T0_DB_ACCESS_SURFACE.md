...
- T0.3.23 tail audit found remaining doctor/admin mutation residuals before T0.4: booking manual create (#613), booking cancelled appointment purge (#614), booking package detach/refund/unlink (#615), doctor broadcasts (#616), doctor LFK exercise/template catalog (#617), doctor clinical/recommendation/test-set catalog (#618), doctor courses/treatment-template catalog (#619), and admin media/references (#620). Do not treat T0.3 as closed until these are done/sealed and a final tail audit passes.
