...
- [ ] **B0.3 Удалить моки после настоящего checkout (владелец 01.08: «сначала реальный механизм, потом
      удаление… мы не будем держать опасные моки на проде»).** Как только оплата через ЮKassa работает
