...
- [x] **B0.3 Удалить моки (владелец 01.08: «моки удаляй»; ранее — «мы не будем держать опасные моки на проде»).** Как только оплата через ЮKassa работает
      ...
      системой, не индексом. Ложное evidence «гейт 8/8 продолжает сторожить» снято: B0.2 измеряется отдельно
      как gate отсутствия маршрутов и predicate-файла; B0.2 остаётся открытым до независимого аудита._
