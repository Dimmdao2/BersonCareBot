...
| `docs/OPERATIONS/BOOKING_CANONICAL_CUTOVER.md` | `updated_with_retirement_entrypoint` | Rubitime retirement owner | Existing canonical cutover remains the operational background; current Rubitime retirement entrypoint is `docs/OPERATIONS/RUBITIME_R1_FRESH_PROD_DUMP_AGENT_README.md`. After production cutoff, add actual production run output and rollback boundary. |
