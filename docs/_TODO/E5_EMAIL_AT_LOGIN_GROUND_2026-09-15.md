...
5. **Mini App отключается целиком**, поэтому отдельного обхода почты через него не существует.
   Включат обратно — входит в ту же лестницу без исключений.
   *Владелец; канон — `AUTH_AND_IDENTITY_CANON.md`, раздел о снятых входах.*
