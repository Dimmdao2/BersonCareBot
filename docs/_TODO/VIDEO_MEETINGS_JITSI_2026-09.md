...
- [x] **LIVE-04.** Участников зовут по именам: специалиста — его именем из карточки клиники, клиента — его ФИО.
      ...
      ⚠️ По ГОСТЕВОЙ ссылке имя клиента остаётся нейтральным «Клиент»: сессии человека там нет вовсе и
      законного чтения его ПДн не существует. Настоящее ФИО потребовало бы именованного корня с
      объявленной возможностью — отдельная работа и отдельное решение владельца.
