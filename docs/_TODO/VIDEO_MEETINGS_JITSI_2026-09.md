...
- [ ] **LIVE-01.** Клиентский экран звонка занимает весь экран. Причина дефекта измерена, а не угадана: гостевая
...
- [ ] **LIVE-02.** Копирование гостевой ссылки даёт человеку видимое подтверждение («Ссылка скопирована»),
      как в остальных местах кабинета; текст берётся из общего словаря, а не пишется на месте.
- [ ] **LIVE-03.** Вместо «Приглашение поставлено в очередь» специалист видит, что именно произошло с точки
...
- [ ] **LIVE-04.** Участников зовут по именам: специалиста — его именем из карточки клиники, клиента — его ФИО.
...
- [ ] **LIVE-05.** Собственная плитка специалиста расположена так, что не выглядит случайной.
