...
| `RU_PRIVACY_AND_PRODUCTION_READINESS/stages/NTF-01_APP_PUSH_AND_MESSENGER_AUTH_ONLY.md` | 26 | 19 | 12 | ВЫТЕСНЕН | «SUPERSEDED AS TARGET — 2026-07-27»; заменяющий канон — `OWNER_PRODUCT_RULES.md` §21–§25 через строку «Уведомления» в `CURRENT_AUTHORITY_MAP.md` (`RU_PRIVACY_AND_PRODUCTION_READINESS/stages/NTF-01_APP_PUSH_AND_MESSENGER_AUTH_ONLY.md:5-10`). | архив |
