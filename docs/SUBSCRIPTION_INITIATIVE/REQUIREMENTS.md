...
6. Тесты — по масштабу изменения; полный CI — только для конкретного непокрытого интеграционного риска по [`AGENTS.md` §9](../../AGENTS.md#9-full-ci-gate), не формально перед push. Хостовый запуск и блокировка — по действующему канону `AGENTS.md`.
