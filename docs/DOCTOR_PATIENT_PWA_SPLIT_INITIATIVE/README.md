...
**Статус:** волна 1 **done** · волна 2 §A (access+toast) **done** · §B Staff PWA — `planned`
...
| **2** | §A блок+toast **done** · §B **Staff PWA** (BersonAdmin) — [`WAVE2_STAFF_PWA.md`](WAVE2_STAFF_PWA.md) |
...
3. [`ACCEPTANCE_WAVE2.md`](ACCEPTANCE_WAVE2.md) — приёмка волны 2 (§access done, §B planned).
4. [`WAVE2_STAFF_PWA.md`](WAVE2_STAFF_PWA.md) — план волны 2.
5. [`SCOPE_BOUNDARIES.md`](SCOPE_BOUNDARIES.md) — patient frozen.
6. [`INVENTORY_AND_MATRIX.md`](INVENTORY_AND_MATRIX.md) — аудит staff routes + матрица §A.
7. [`LOG.md`](LOG.md) — журнал.
