...
- [x] **Редактор инстанса — batch-toolbar (фазы 1–6, 2026-06-03):** sticky toolbar, stage-order modal, collapsible pipeline-этапы, общий диалог комментариев (`DoctorProgramInstanceDiscussionDialog`, instance discussion API, summary в фильтре). **Следующее:** ф.7 — история, unsaved gate, регрессия.
