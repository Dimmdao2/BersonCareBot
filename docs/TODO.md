...
- [x] **Редактор инстанса — batch-toolbar (фазы 1–5, 2026-06-03):** sticky toolbar, stage-order modal, collapsible pipeline-этапы, audit remediation. **Следующее:** ф.6 — общий диалог комментариев.
