...
- [x] **Редактор инстанса — batch-toolbar (фазы 1–3, 2026-06-03):** `program_changed`, `runInMutationTransaction`, pre-validate reorder/structural/loadSettings; unsaved gate metadata-only. **Следующее:** фаза 4 — sticky toolbar.
