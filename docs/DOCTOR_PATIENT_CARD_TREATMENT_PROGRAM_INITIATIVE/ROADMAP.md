...
**Операционная очередь (фазы 0–7):** [`docs/ACTIVE_WORKQUEUE.md`](../ACTIVE_WORKQUEUE.md) — фазы **3** (черновик редактора) и **4** (фильтры picker библиотеки) закрыты 2026-06-02; **следующая — 5** (inbox «Сегодня»).
