...
**Статус:** ✅ **MASTER_PLAN закрыт** (2026-05-05); ручной smoke назначения — ✅ owner 2026-06-01. ✅ **Карточка врача (2A–2B)** и ✅ **задачи специалиста (2C)** — 2026-06-02. ✅ **Черновик редактора программы (фаза 3)** — 2026-06-02. ✅ **Фильтры каталога в модалке экземпляра (фаза 4)** — 2026-06-02. **Следующий контур:** фаза **5** (inbox «Сегодня») — [`docs/TODO.md`](../TODO.md) §Doctor card; очередь [`.cursor/plans/archive/active_workqueue_plan_30236040.plan.md`](../../.cursor/plans/archive/active_workqueue_plan_30236040.plan.md).
