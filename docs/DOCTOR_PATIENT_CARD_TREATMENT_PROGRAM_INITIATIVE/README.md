...
**Статус:** ✅ **MASTER_PLAN закрыт** (2026-05-05); ручной smoke назначения — ✅ owner 2026-06-01. **Следующий контур** (карточка, сопровождение, черновик редактора программы) — [`docs/TODO.md`](../TODO.md) §Doctor card; [`ROADMAP.md`](ROADMAP.md) §продуктовые решения.
