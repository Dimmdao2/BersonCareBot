...
2. **Ссылки «Полезная информация» / `/help`.** **2026-05-01:** убраны битые плитки без контента (см. [`LOG.md`](LOG.md) §пункт 6). **2026-06-02 (фаза 6):** `/help` из CMS; **2026-06-03:** IA canonical slug; плитки на `/app/patient/booking/new` (`CabinetInfoLinks`); **фаза 3:** city-aware «Адрес» (`address-msk` / `address-spb`, `patientHelpAddressLink`, `bookingNewHref`) — план `patient_help_booking_surface` фазы 1–3 закрыты.
