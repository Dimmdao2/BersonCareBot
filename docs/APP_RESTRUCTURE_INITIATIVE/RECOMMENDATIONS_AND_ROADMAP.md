...
2. **Ссылки «Полезная информация» / `/help`.** **2026-05-01:** убраны битые плитки без контента (см. [`LOG.md`](LOG.md) §пункт 6). **2026-06-02 (фаза 6):** `/help` из CMS; **2026-06-03:** IA canonical slug; плитки при опубликованных статьях; **смонтировано** на `/app/patient/booking/new` (`CabinetInfoLinks surface="booking"`, план patient_help_booking фаза 2).
