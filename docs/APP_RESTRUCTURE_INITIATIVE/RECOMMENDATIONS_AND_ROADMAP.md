...
| Режимы / тестовые аккаунты / dev relay | **2026-05-02:** вкладка «Режимы» — `test_account_identifiers`, bypass техработ для тестовых клиентов, `dev_mode` relay по `channel`+`recipient` (без internal userId в UI). Аудит и чек-листы: [`MODES_AND_TEST_ACCOUNTS_EXECUTION_AUDIT.md`](MODES_AND_TEST_ACCOUNTS_EXECUTION_AUDIT.md); зеркало плана: [`MODES_SETTINGS_CLEANUP_PLAN.md`](MODES_SETTINGS_CLEANUP_PLAN.md). |
