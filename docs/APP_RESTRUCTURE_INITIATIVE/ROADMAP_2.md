...
- Shadcn/Base UI alignment patient-слоя (инвентаризация + примитивы `Collapsible`/`Accordion` в `components/ui`, **2026-05-04**): [`../PATIENT_APP_SHADCN_ALIGNMENT_INITIATIVE/README.md`](../PATIENT_APP_SHADCN_ALIGNMENT_INITIATIVE/README.md) · [`LOG.md`](../PATIENT_APP_SHADCN_ALIGNMENT_INITIATIVE/LOG.md).
