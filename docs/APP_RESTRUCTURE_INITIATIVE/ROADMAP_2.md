...
- Shadcn/Base UI alignment patient-слоя (**2026-05-04:** Phase 0–1 примитивы + **Phase 2–5** экраны — кабинет, `FeatureCard`, профиль, `ChannelNotificationToggles`; см. [`LOG.md`](../PATIENT_APP_SHADCN_ALIGNMENT_INITIATIVE/LOG.md)): [`../PATIENT_APP_SHADCN_ALIGNMENT_INITIATIVE/README.md`](../PATIENT_APP_SHADCN_ALIGNMENT_INITIATIVE/README.md) · [`LOG.md`](../PATIENT_APP_SHADCN_ALIGNMENT_INITIATIVE/LOG.md).
