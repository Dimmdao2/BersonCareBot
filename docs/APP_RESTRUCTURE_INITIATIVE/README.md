...
| [`DOCTOR_NAV_BADGES_PLAN.md`](DOCTOR_NAV_BADGES_PLAN.md) | ТЗ этапа 3: бейджи новых онлайн-заявок и непрочитанных сообщений в меню врача | **выполнено** |
| [`DOCTOR_TODAY_DASHBOARD_PLAN.md`](DOCTOR_TODAY_DASHBOARD_PLAN.md) | ТЗ этапа 4: рабочий экран «Сегодня» вместо отчётного обзора | **выполнено** |
...
| [`DOCTOR_CLIENT_PROFILE_REPACK_PLAN.md`](DOCTOR_CLIENT_PROFILE_REPACK_PLAN.md) | ТЗ к этапу 6: пересборка карточки пациента из имеющихся блоков (без аккордеонов, sticky-шапка, плоские секции), компактный список клиентов с иконочными бейджами каналов, удаление заглушки «Создать из записи на приём» | **выполнено** |
| [`DOCTOR_CLIENT_PROFILE_REPACK_EXECUTION_AUDIT.md`](DOCTOR_CLIENT_PROFILE_REPACK_EXECUTION_AUDIT.md) | Аудит выполнения REPACK (чек-листы ТЗ §5, синхронизация документов, остаточные хвосты) | **живой** (фиксирует закрытие 2026-05-02) |
...
| [`DOCTOR_UI_DENSITY_PLAN.md`](DOCTOR_UI_DENSITY_PLAN.md) | ТЗ на плотность UI врача (этап 8 плана кабинета) | **выполнено** (документ остаётся справочником) |
...
| [`MODES_BATCH_PATCH_AND_PHONE_PREVIEW_PLAN.md`](MODES_BATCH_PATCH_AND_PHONE_PREVIEW_PLAN.md) | Зеркало плана: составной PATCH «Режимы» + preview телефонов тестовых аккаунтов | **закрыт** — см. §«Третий прогон» в [`MODES_AND_TEST_ACCOUNTS_EXECUTION_AUDIT.md`](MODES_AND_TEST_ACCOUNTS_EXECUTION_AUDIT.md) |
| [`MODES_AND_TEST_ACCOUNTS_EXECUTION_AUDIT.md`](MODES_AND_TEST_ACCOUNTS_EXECUTION_AUDIT.md) | Режимы, `test_account_identifiers`, bypass техработ, dev_mode relay, batch-save, phone preview: DoD, чек-листы, команды верификации | **живой** (история закрытия) |
