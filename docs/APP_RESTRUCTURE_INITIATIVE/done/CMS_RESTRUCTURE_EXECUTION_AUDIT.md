...
**Обновление 2026-05-02 (Variant C+):** UX системных папок, перенос существующих разделов в кластер, контекстное создание страниц и ужесточение кандидатов `subscription_carousel` зафиксированы в [LOG.md](../LOG.md) («CMS Post-Execution Fix»); исходный аудит варианта C остаётся валидным для миграции и таксономии `kind` / `system_parent_code`.
