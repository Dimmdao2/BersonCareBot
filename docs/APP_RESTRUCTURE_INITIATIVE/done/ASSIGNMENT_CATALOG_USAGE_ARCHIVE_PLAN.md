...
- `apps/webapp/src/app/app/doctor/lfk-templates/**`;
- `apps/webapp/src/modules/lfk-templates/**`;
- `apps/webapp/src/modules/lfk-assignments/**` _(опционально: usage для шага 2 собирается в `pgLfkTemplates` из `patient_lfk_assignments`; отдельный модуль не обязателен)_;
- `apps/webapp/src/infra/repos/pgLfkTemplates.ts`;
- `apps/webapp/src/infra/repos/pgLfkAssignments.ts` _(опционально — см. выше)_.
