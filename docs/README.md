...
- **Patient treatment programs polish (`ROADMAP_2` §1.0–1.1a):** [`PATIENT_TREATMENT_PROGRAMS_POLISH_INITIATIVE/README.md`](PATIENT_TREATMENT_PROGRAMS_POLISH_INITIATIVE/README.md).
