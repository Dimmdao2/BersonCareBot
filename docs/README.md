...
| **CONFIGURATION_ENV_VS_DATABASE.md** | Где хранить настройки: env (секреты, DSN, процесс) vs `system_settings` в БД (несекретная runtime-конфигурация). |
...
### BRANCH_UX_CMS_BOOKING/ — текущая ветка разработки (2026-03)

Документация активной ветки: чистка UI/UX, CMS/медиабиблиотека, нативный модуль записи.

| Файл | Назначение |
|------|------------|
| **OVERVIEW.md** | Контекст ветки, цели, ссылки, модели агентов. |
| **PLAN.md** | Мастер-план: фазы 0–4, задачи, зависимости, оценки. |
...
| Файл | Назначение |
|------|------------|
| **UX_ANALYSIS_2026-03-31.md** | Полный аудит UI/UX: ошибки, заглушки, план развития. |
