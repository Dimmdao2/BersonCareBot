...
- **AUTH / вход (реструктуризация, см. также Mini App до контакта):** `AUTH_RESTRUCTURE/MASTER_PLAN.md` · журнал: `AUTH_RESTRUCTURE/AGENT_EXECUTION_LOG.md` · гейт Mini App: `AUTH_RESTRUCTURE/BOT_CONTACT_MINI_APP_GATE.md`
