...
- **Админка `/app/settings`: вкладка «Здоровье системы» + mobile tabs fix:** журнал `SETTINGS_ADMIN_UI_TABS/EXECUTION_LOG.md` (запись 2026-04-16 про `GET /api/admin/system-health`, ограничения variant 1 и backup placeholder).
