...
- `docs/VIDEO_HLS_DELIVERY/00-master-plan.md`
- `docs/VIDEO_HLS_DELIVERY/01-current-state-and-gap-analysis.md`
- `docs/VIDEO_HLS_DELIVERY/02-target-architecture.md`
- `docs/VIDEO_HLS_DELIVERY/03-rollout-strategy.md`
- `docs/VIDEO_HLS_DELIVERY/04-test-strategy.md`
- `docs/VIDEO_HLS_DELIVERY/05-risk-register.md`
- `docs/VIDEO_HLS_DELIVERY/06-execution-log.md`
- `docs/VIDEO_HLS_DELIVERY/07-post-documentation-implementation-roadmap.md`
- Все phase-файлы в `docs/VIDEO_HLS_DELIVERY/phases/`
...
10. После каждого EXEC/FIX обновляй `docs/VIDEO_HLS_DELIVERY/06-execution-log.md`.

Файлы аудитов:

- `docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_01.md`
- `docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_02.md`
- `docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_03.md`
- `docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_04.md`
- `docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_05.md`
- `docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_06.md`
- `docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_07.md`
- `docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_08.md`
- `docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_09.md`
- `docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_10.md`
- `docs/VIDEO_HLS_DELIVERY/AUDIT_GLOBAL.md`
- `docs/VIDEO_HLS_DELIVERY/AUDIT_PREPUSH_POSTFIX.md`
...
Вход:
- docs/VIDEO_HLS_DELIVERY/phases/phase-01-data-model-and-dual-delivery-foundation.md
- docs/VIDEO_HLS_DELIVERY/02-target-architecture.md
...
Обнови docs/VIDEO_HLS_DELIVERY/06-execution-log.md.
```
...
Сохрани: docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_01.md
...
```text
Выполни FIX по docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_01.md.
...
Вход:
- docs/VIDEO_HLS_DELIVERY/phases/phase-02-transcoding-pipeline-and-worker.md
- docs/VIDEO_HLS_DELIVERY/02-target-architecture.md
...
Сохрани: docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_02.md
...
```text
Выполни FIX по docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_02.md.
...
Вход:
- docs/VIDEO_HLS_DELIVERY/phases/phase-03-storage-layout-and-artifact-management.md
...
Сохрани: docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_03.md
Добавь MANDATORY FIX INSTRUCTIONS.
```
...
```text
Выполни FIX по docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_03.md.
...
Вход:
- docs/VIDEO_HLS_DELIVERY/phases/phase-04-playback-api-and-delivery-strategy.md
...
Сохрани: docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_04.md
Добавь MANDATORY FIX INSTRUCTIONS.
```
...
```text
Выполни FIX по docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_04.md.
...
Вход:
- docs/VIDEO_HLS_DELIVERY/phases/phase-05-player-integration-and-dual-mode-frontend.md
...
Сохрани: docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_05.md
Добавь MANDATORY FIX INSTRUCTIONS.
```
...
```text
Выполни FIX по docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_05.md.
...
Вход:
- docs/VIDEO_HLS_DELIVERY/phases/phase-06-new-video-hls-default-path.md
...
Сохрани: docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_06.md
Добавь MANDATORY FIX INSTRUCTIONS.
```
...
```text
Выполни FIX по docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_06.md.
...
Вход:
- docs/VIDEO_HLS_DELIVERY/phases/phase-07-backfill-legacy-library.md
...
Сохрани: docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_07.md
Добавь MANDATORY FIX INSTRUCTIONS.
```
...
```text
Выполни FIX по docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_07.md.
...
Вход:
- docs/VIDEO_HLS_DELIVERY/phases/phase-08-default-switch-to-hls.md
- docs/VIDEO_HLS_DELIVERY/03-rollout-strategy.md
...
Сохрани: docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_08.md
Добавь MANDATORY FIX INSTRUCTIONS.
```
...
```text
Выполни FIX по docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_08.md.
...
Вход:
- docs/VIDEO_HLS_DELIVERY/phases/phase-09-signed-urls-ttl-and-private-access.md
...
Сохрани: docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_09.md
Добавь MANDATORY FIX INSTRUCTIONS.
```
...
```text
Выполни FIX по docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_09.md.
...
Вход:
- docs/VIDEO_HLS_DELIVERY/phases/phase-10-watermark-and-further-hardening.md
...
Сохрани: docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_10.md
Добавь MANDATORY FIX INSTRUCTIONS.
```
...
```text
Выполни FIX по docs/VIDEO_HLS_DELIVERY/AUDIT_PHASE_10.md.
...
Сохрани: docs/VIDEO_HLS_DELIVERY/AUDIT_GLOBAL.md
```

## GLOBAL FIX

```text
Выполни global fix по docs/VIDEO_HLS_DELIVERY/AUDIT_GLOBAL.md.
...
4) Обнови docs/VIDEO_HLS_DELIVERY/06-execution-log.md итоговой записью по global fix.
```
...
Сохрани: docs/VIDEO_HLS_DELIVERY/AUDIT_PREPUSH_POSTFIX.md
```
