# Отчёты и runbook-логи (актуальные файлы в каталоге)

Остальные разовые журналы и снимки перенесены в [`../archive/2026-04-docs-cleanup/README.md`](../archive/2026-04-docs-cleanup/README.md).
