...
- ОДИН раз на ЗАВЕРШЁННОМ сведении: все ветки влиты, дерево чистое, писателей нет — тогда полный прогон
  ...
  владельцем 20.08 как неверная и бессмысленная: пока невлитых веток десять, «перед merge» наступает
  десять раз, и каждый прогон меряет дерево, которого через час не будет. Правки по ходу сведения
