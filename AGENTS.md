...
- **Записать решение ≠ завести задачу.** Владелец 28.07: «я просил? убирай свой самовол». Решение вписывается
  ТУДА, ГДЕ ОПИСАНА ПРОБЛЕМА — в существующую карточку или файл. Новая карточка заводится только если владелец
  об этом попросил. Назначать исполнителем владельца, ставить сроки и помечать «агентам не брать» — не твоё
