...
- Новый тест принимается после одной целевой мутации или fault injection, которая ломает заявленное правило и
  делает тест красным. Не строить ради этого новый глобальный фреймворк, если достаточно локальной проверки.
...
5. для нового поведения показана целевая мутация/fault injection;
