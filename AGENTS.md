...
- На именованных live DEV/TEST запрещено создавать, сидировать, reconcile-ить или требовать persistent fixture
  клиники, учётки и наборы данных. Проверки используют уже зарегистрированные owner-учётки и клиники. Поведенческий
  probe может менять данные только внутри гарантированно откатываемой транзакции и не оставляет fixture-сущностей.
