...
expect_denied "$scheduler_url" "scheduler cross-contour delivery audit capability" \
  "SET ROLE app_operational_scheduler; SELECT app.record_operational_delivery_attempt_audit('message.send','c4-readiness',NULL,'00000000-0000-4000-8000-000000000000'::uuid,'max','failed',1,NULL,NULL, now());"
