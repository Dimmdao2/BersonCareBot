...
-- This file instead applies, verbatim, the exact five GRANT statements c4-operational-runtime.sql declares
...
--
-- Rollback: REVOKE the same five grants from app_operational_delivery_worker.
--
...
BEGIN
  IF NOT has_schema_privilege('app_operational_delivery_worker', 'app', 'USAGE')
     ...
     OR NOT has_table_privilege('app_operational_delivery_worker', 'integrator.message_retry_jobs', 'SELECT, UPDATE')
