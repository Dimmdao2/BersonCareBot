...
-- This file instead applies, verbatim, the remaining GRANT statements c4-operational-runtime.sql declares
...
--
-- Rollback: REVOKE the same three grants from app_operational_delivery_worker.
--
