...
BEGIN
  ...
  END IF;
  IF pg_catalog.current_database() <> 'therapysto_prod' THEN
    RAISE EXCEPTION 'allowlist базы % применён к базе %', 'therapysto_prod', pg_catalog.current_database();
  END IF;
END
$bcb$;
