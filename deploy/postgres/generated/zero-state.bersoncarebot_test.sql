...
BEGIN
  ...
  END IF;
  IF EXISTS (SELECT 1 FROM pg_catalog.pg_roles WHERE rolname = ANY (ARRAY['app_bootstrap_base_c1_20260713021531', 'app_clinic_billing', 'app_config_reader', 'app_identity_bootstrap', 'app_integrator_request', 'app_integrator_resolver', 'app_member', 'app_migration_phase', 'app_object_owner', 'app_operational_delivery_worker', 'app_operational_diagnostic', 'app_operational_media_worker', 'app_operational_scheduler', 'app_operational_web_push_reminder', 'app_owner', 'app_patient', 'app_platform_settings', 'app_pre_session', 'app_runtime_login_c1_20260713021531', 'app_runtime_settings', 'app_seam_catalog_admin_owner', 'app_seam_catalog_public_owner', 'app_seam_context_owner', 'app_seam_dedicated_bot_owner', 'app_seam_delivery_scope_owner', 'app_seam_email_otp_owner', 'app_seam_identity_lookup_owner', 'app_seam_login_token_owner', 'app_seam_oauth_owner', 'app_seam_org_commerce_owner', 'app_seam_org_directory_owner', 'app_seam_org_invite_owner', 'app_seam_passkey_owner', 'app_seam_password_auth_owner', 'app_seam_patient_booking_owner', 'app_seam_patient_invite_owner', 'app_seam_patient_lfk_media_owner', 'app_seam_patient_org_projection_owner', 'app_seam_patient_program_resolver_owner', 'app_seam_patient_self_actions_owner', 'app_seam_payment_webhook_owner', 'app_seam_phone_binding_owner', 'app_seam_phone_otp_owner', 'app_seam_public_booking_owner', 'app_seam_public_slug_owner', 'app_seam_reminder_appointment_owner', 'app_seam_reminder_email_cooldown_owner', 'app_seam_reminder_materialization_owner', 'app_seam_reminder_patient_owner', 'app_seam_reminder_specialist_owner', 'app_seam_self_security_owner', 'app_seam_settings_integrator_owner', 'app_seam_settings_preauth_owner', 'app_seam_settings_runtime_owner', 'app_seam_specialist_provision_owner', 'app_seam_staff_security_owner', 'app_seam_telemetry_exclusion_owner', 'app_seam_telemetry_media_owner', 'app_seam_telemetry_operator_owner', 'app_seam_telemetry_patient_owner', 'app_service', 'app_staff', 'app_tenant_service', 'app_web_push_reminder_discovery_definer', 'app_worker', 'bcb_dev', 'bcb_dev_integrator', 'bcb_dev_migrator', 'bcb_dev_runtime_nonstaff_login', 'bcb_dev_runtime_staff_login', 'bcb_dev_webapp_patient', 'bcb_dev_webapp_staff', 'bcb_saas_diag_test', 'bcb_saas_operator_dev', 'bcb_saas_operator_test', 'bcb_test_integrator', 'bcb_test_integrator_login', 'bcb_test_maintenance_login', 'bcb_test_migrator', 'bcb_test_nonstaff_login', 'bcb_test_operational_delivery_login', 'bcb_test_operational_diagnostic_login', 'bcb_test_operational_media_login', 'bcb_test_operational_scheduler_login', 'bcb_test_operational_web_push_reminder_login', 'bcb_test_staff_login', 'bcb_test_webapp_patient', 'bcb_test_webapp_staff', 'bcb_test_worker_login', 'bcb_webapp_dev_user', 'bersoncarebot_test', 'saas_system_health_owner', 'saas_telemetry_operator', 'saas_telemetry_owner']::name[]) AND rolsuper) THEN
    RAISE EXCEPTION 'an application identity is SUPERUSER; zero-state refuses a silent exclusion';
  END IF;
END
$bcb$;
INSERT INTO bcb_zero_state_roles SELECT rolname FROM pg_catalog.pg_roles WHERE rolname = ANY (ARRAY['app_bootstrap_base_c1_20260713021531', 'app_clinic_billing', 'app_config_reader', 'app_identity_bootstrap', 'app_integrator_request', 'app_integrator_resolver', 'app_member', 'app_migration_phase', 'app_object_owner', 'app_operational_delivery_worker', 'app_operational_diagnostic', 'app_operational_media_worker', 'app_operational_scheduler', 'app_operational_web_push_reminder', 'app_owner', 'app_patient', 'app_platform_settings', 'app_pre_session', 'app_runtime_login_c1_20260713021531', 'app_runtime_settings', 'app_seam_catalog_admin_owner', 'app_seam_catalog_public_owner', 'app_seam_context_owner', 'app_seam_dedicated_bot_owner', 'app_seam_delivery_scope_owner', 'app_seam_email_otp_owner', 'app_seam_identity_lookup_owner', 'app_seam_login_token_owner', 'app_seam_oauth_owner', 'app_seam_org_commerce_owner', 'app_seam_org_directory_owner', 'app_seam_org_invite_owner', 'app_seam_passkey_owner', 'app_seam_password_auth_owner', 'app_seam_patient_booking_owner', 'app_seam_patient_invite_owner', 'app_seam_patient_lfk_media_owner', 'app_seam_patient_org_projection_owner', 'app_seam_patient_program_resolver_owner', 'app_seam_patient_self_actions_owner', 'app_seam_payment_webhook_owner', 'app_seam_phone_binding_owner', 'app_seam_phone_otp_owner', 'app_seam_public_booking_owner', 'app_seam_public_slug_owner', 'app_seam_reminder_appointment_owner', 'app_seam_reminder_email_cooldown_owner', 'app_seam_reminder_materialization_owner', 'app_seam_reminder_patient_owner', 'app_seam_reminder_specialist_owner', 'app_seam_self_security_owner', 'app_seam_settings_integrator_owner', 'app_seam_settings_preauth_owner', 'app_seam_settings_runtime_owner', 'app_seam_specialist_provision_owner', 'app_seam_staff_security_owner', 'app_seam_telemetry_exclusion_owner', 'app_seam_telemetry_media_owner', 'app_seam_telemetry_operator_owner', 'app_seam_telemetry_patient_owner', 'app_service', 'app_staff', 'app_tenant_service', 'app_web_push_reminder_discovery_definer', 'app_worker', 'bcb_dev', 'bcb_dev_integrator', 'bcb_dev_migrator', 'bcb_dev_runtime_nonstaff_login', 'bcb_dev_runtime_staff_login', 'bcb_dev_webapp_patient', 'bcb_dev_webapp_staff', 'bcb_saas_diag_test', 'bcb_saas_operator_dev', 'bcb_saas_operator_test', 'bcb_test_integrator', 'bcb_test_integrator_login', 'bcb_test_maintenance_login', 'bcb_test_migrator', 'bcb_test_nonstaff_login', 'bcb_test_operational_delivery_login', 'bcb_test_operational_diagnostic_login', 'bcb_test_operational_media_login', 'bcb_test_operational_scheduler_login', 'bcb_test_operational_web_push_reminder_login', 'bcb_test_staff_login', 'bcb_test_webapp_patient', 'bcb_test_webapp_staff', 'bcb_test_worker_login', 'bcb_webapp_dev_user', 'bersoncarebot_test', 'saas_system_health_owner', 'saas_telemetry_operator', 'saas_telemetry_owner']::name[]);
...
DO $bcb$ DECLARE target record; BEGIN
  FOR target IN SELECT role_name FROM bcb_zero_state_roles ORDER BY role_name LOOP
    EXECUTE pg_catalog.format('REVOKE ALL PRIVILEGES ON DATABASE %I FROM %I', 'bersoncarebot_test', target.role_name);
...
DO $bcb$ DECLARE object record; BEGIN
  ...
  FOR object IN SELECT namespace.nspname, object_type.typname
                 ...
                 WHERE namespace.nspname <> 'information_schema' AND namespace.nspname !~ '^pg_'
                   AND object_type.typtype IN ('b','d','e','r') AND object_type.typelem = 0
                   AND object_type.typrelid = 0 ORDER BY 1, 2 LOOP
...
DO $bcb$ DECLARE bad text; BEGIN
  ...
  WITH acl(grantee, owner_oid, object_name) AS (
    ...
    UNION ALL SELECT acl.grantee, object.typowner, 'type:' || namespace.nspname || '.' || object.typname FROM pg_catalog.pg_type object JOIN pg_catalog.pg_namespace namespace ON namespace.oid = object.typnamespace CROSS JOIN LATERAL pg_catalog.aclexplode(coalesce(object.typacl, pg_catalog.acldefault('T', object.typowner))) acl
      WHERE namespace.nspname <> 'information_schema' AND namespace.nspname !~ '^pg_' AND object.typtype IN ('b','d','e','r') AND object.typelem = 0 AND object.typrelid = 0
  ...
  WITH owner_ref(owner_oid, object_name) AS (
    ...
    UNION ALL SELECT object.typowner, 'type:' || namespace.nspname || '.' || object.typname FROM pg_catalog.pg_type object JOIN pg_catalog.pg_namespace namespace ON namespace.oid = object.typnamespace WHERE namespace.nspname <> 'information_schema' AND namespace.nspname !~ '^pg_' AND object.typrelid = 0
