...
INSERT INTO bcb_zero_state_roles (role_name) VALUES ('app_bootstrap_base_c1_20260713021531'::name), ('app_clinic_billing'::name), ('app_identity_bootstrap'::name), ('app_integrator_request'::name), ('app_integrator_resolver'::name), ('app_migrator'::name), ('app_object_owner'::name), ('app_operational_delivery_worker'::name), ('app_operational_diagnostic'::name), ('app_operational_maintenance'::name), ('app_operational_media_worker'::name), ('app_operational_scheduler'::name), ('app_operational_web_push_reminder'::name), ('app_owner'::name), ('app_patient'::name), ('app_phone_bind_completion'::name), ('app_platform_admin'::name), ('app_platform_settings'::name), ('app_pre_session'::name), ('app_runtime_login_c1_20260713021531'::name), ('app_seam_catalog_admin_owner'::name), ('app_seam_catalog_public_owner'::name), ('app_seam_context_owner'::name), ('app_seam_dedicated_bot_owner'::name), ('app_seam_delivery_scope_owner'::name), ('app_seam_email_otp_owner'::name), ('app_seam_identity_lookup_owner'::name), ('app_seam_login_token_owner'::name), ('app_seam_oauth_owner'::name), ('app_seam_org_commerce_owner'::name), ('app_seam_org_directory_owner'::name), ('app_seam_org_invite_owner'::name), ('app_seam_passkey_owner'::name), ('app_seam_password_auth_owner'::name), ('app_seam_patient_booking_owner'::name), ('app_seam_patient_invite_owner'::name), ('app_seam_patient_lfk_media_owner'::name), ('app_seam_patient_org_projection_owner'::name), ('app_seam_patient_program_resolver_owner'::name), ('app_seam_patient_self_actions_owner'::name), ('app_seam_payment_webhook_owner'::name), ('app_seam_phone_binding_owner'::name), ('app_seam_phone_otp_owner'::name), ('app_seam_public_booking_owner'::name), ('app_seam_public_slug_owner'::name), ('app_seam_reminder_appointment_owner'::name), ('app_seam_reminder_email_cooldown_owner'::name), ('app_seam_reminder_materialization_owner'::name), ('app_seam_reminder_patient_owner'::name), ('app_seam_reminder_specialist_owner'::name), ('app_seam_self_security_owner'::name), ('app_seam_settings_integrator_owner'::name), ('app_seam_settings_preauth_owner'::name), ('app_seam_settings_runtime_owner'::name), ('app_seam_specialist_provision_owner'::name), ('app_seam_staff_security_owner'::name), ('app_seam_telemetry_exclusion_owner'::name), ('app_seam_telemetry_media_owner'::name), ('app_seam_telemetry_operator_owner'::name), ('app_seam_telemetry_patient_owner'::name), ('app_service'::name), ('app_staff'::name), ('app_tenant_service'::name), ('app_web_push_reminder_discovery_definer'::name), ('app_worker'::name), ('bcb_dev'::name), ('bcb_dev_integrator'::name), ('bcb_dev_migrator'::name), ('bcb_dev_runtime_nonstaff_login'::name), ('bcb_dev_runtime_staff_login'::name), ('bcb_dev_webapp_global_admin'::name), ('bcb_dev_webapp_patient'::name), ('bcb_dev_webapp_staff'::name), ('bcb_saas_diag_test'::name), ('bcb_saas_operator_dev'::name), ('bcb_saas_operator_test'::name), ('bcb_test_integrator'::name), ('bcb_test_integrator_login'::name), ('bcb_test_maintenance_login'::name), ('bcb_test_migrator'::name), ('bcb_test_nonstaff_login'::name), ('bcb_test_operational_delivery_login'::name), ('bcb_test_operational_diagnostic_login'::name), ('bcb_test_operational_media_login'::name), ('bcb_test_operational_scheduler_login'::name), ('bcb_test_operational_web_push_reminder_login'::name), ('bcb_test_staff_login'::name), ('bcb_test_webapp_global_admin'::name), ('bcb_test_webapp_patient'::name), ('bcb_test_webapp_staff'::name), ('bcb_test_worker_login'::name), ('bcb_webapp_dev_user'::name), ('bcb_webapp_prod'::name), ('bersoncarebot_test'::name), ('saas_system_health_owner'::name), ('saas_telemetry_operator'::name), ('saas_telemetry_owner'::name);
...
BEGIN
  ...
  IF pg_catalog.current_database() <> 'bersoncarebot_test' THEN
    RAISE EXCEPTION 'zero-state for % applied to %', 'bersoncarebot_test', pg_catalog.current_database();
  END IF;
  IF EXISTS (SELECT 1 FROM pg_catalog.pg_roles WHERE rolname = ANY (ARRAY['app_bootstrap_base_c1_20260713021531', 'app_clinic_billing', 'app_identity_bootstrap', 'app_integrator_request', 'app_integrator_resolver', 'app_migrator', 'app_object_owner', 'app_operational_delivery_worker', 'app_operational_diagnostic', 'app_operational_maintenance', 'app_operational_media_worker', 'app_operational_scheduler', 'app_operational_web_push_reminder', 'app_owner', 'app_patient', 'app_phone_bind_completion', 'app_platform_admin', 'app_platform_settings', 'app_pre_session', 'app_runtime_login_c1_20260713021531', 'app_seam_catalog_admin_owner', 'app_seam_catalog_public_owner', 'app_seam_context_owner', 'app_seam_dedicated_bot_owner', 'app_seam_delivery_scope_owner', 'app_seam_email_otp_owner', 'app_seam_identity_lookup_owner', 'app_seam_login_token_owner', 'app_seam_oauth_owner', 'app_seam_org_commerce_owner', 'app_seam_org_directory_owner', 'app_seam_org_invite_owner', 'app_seam_passkey_owner', 'app_seam_password_auth_owner', 'app_seam_patient_booking_owner', 'app_seam_patient_invite_owner', 'app_seam_patient_lfk_media_owner', 'app_seam_patient_org_projection_owner', 'app_seam_patient_program_resolver_owner', 'app_seam_patient_self_actions_owner', 'app_seam_payment_webhook_owner', 'app_seam_phone_binding_owner', 'app_seam_phone_otp_owner', 'app_seam_public_booking_owner', 'app_seam_public_slug_owner', 'app_seam_reminder_appointment_owner', 'app_seam_reminder_email_cooldown_owner', 'app_seam_reminder_materialization_owner', 'app_seam_reminder_patient_owner', 'app_seam_reminder_specialist_owner', 'app_seam_self_security_owner', 'app_seam_settings_integrator_owner', 'app_seam_settings_preauth_owner', 'app_seam_settings_runtime_owner', 'app_seam_specialist_provision_owner', 'app_seam_staff_security_owner', 'app_seam_telemetry_exclusion_owner', 'app_seam_telemetry_media_owner', 'app_seam_telemetry_operator_owner', 'app_seam_telemetry_patient_owner', 'app_service', 'app_staff', 'app_tenant_service', 'app_web_push_reminder_discovery_definer', 'app_worker', 'bcb_dev', 'bcb_dev_integrator', 'bcb_dev_migrator', 'bcb_dev_runtime_nonstaff_login', 'bcb_dev_runtime_staff_login', 'bcb_dev_webapp_global_admin', 'bcb_dev_webapp_patient', 'bcb_dev_webapp_staff', 'bcb_saas_diag_test', 'bcb_saas_operator_dev', 'bcb_saas_operator_test', 'bcb_test_integrator', 'bcb_test_integrator_login', 'bcb_test_maintenance_login', 'bcb_test_migrator', 'bcb_test_nonstaff_login', 'bcb_test_operational_delivery_login', 'bcb_test_operational_diagnostic_login', 'bcb_test_operational_media_login', 'bcb_test_operational_scheduler_login', 'bcb_test_operational_web_push_reminder_login', 'bcb_test_staff_login', 'bcb_test_webapp_global_admin', 'bcb_test_webapp_patient', 'bcb_test_webapp_staff', 'bcb_test_worker_login', 'bcb_webapp_dev_user', 'bcb_webapp_prod', 'bersoncarebot_test', 'saas_system_health_owner', 'saas_telemetry_operator', 'saas_telemetry_owner']::name[]) AND rolsuper) THEN
    RAISE EXCEPTION 'an application identity is SUPERUSER; zero-state refuses a silent exclusion';
  END IF;
END
$bcb$;
INSERT INTO bcb_zero_state_existing_roles SELECT rolname FROM pg_catalog.pg_roles WHERE rolname = ANY (ARRAY['app_bootstrap_base_c1_20260713021531', 'app_clinic_billing', 'app_identity_bootstrap', 'app_integrator_request', 'app_integrator_resolver', 'app_migrator', 'app_object_owner', 'app_operational_delivery_worker', 'app_operational_diagnostic', 'app_operational_maintenance', 'app_operational_media_worker', 'app_operational_scheduler', 'app_operational_web_push_reminder', 'app_owner', 'app_patient', 'app_phone_bind_completion', 'app_platform_admin', 'app_platform_settings', 'app_pre_session', 'app_runtime_login_c1_20260713021531', 'app_seam_catalog_admin_owner', 'app_seam_catalog_public_owner', 'app_seam_context_owner', 'app_seam_dedicated_bot_owner', 'app_seam_delivery_scope_owner', 'app_seam_email_otp_owner', 'app_seam_identity_lookup_owner', 'app_seam_login_token_owner', 'app_seam_oauth_owner', 'app_seam_org_commerce_owner', 'app_seam_org_directory_owner', 'app_seam_org_invite_owner', 'app_seam_passkey_owner', 'app_seam_password_auth_owner', 'app_seam_patient_booking_owner', 'app_seam_patient_invite_owner', 'app_seam_patient_lfk_media_owner', 'app_seam_patient_org_projection_owner', 'app_seam_patient_program_resolver_owner', 'app_seam_patient_self_actions_owner', 'app_seam_payment_webhook_owner', 'app_seam_phone_binding_owner', 'app_seam_phone_otp_owner', 'app_seam_public_booking_owner', 'app_seam_public_slug_owner', 'app_seam_reminder_appointment_owner', 'app_seam_reminder_email_cooldown_owner', 'app_seam_reminder_materialization_owner', 'app_seam_reminder_patient_owner', 'app_seam_reminder_specialist_owner', 'app_seam_self_security_owner', 'app_seam_settings_integrator_owner', 'app_seam_settings_preauth_owner', 'app_seam_settings_runtime_owner', 'app_seam_specialist_provision_owner', 'app_seam_staff_security_owner', 'app_seam_telemetry_exclusion_owner', 'app_seam_telemetry_media_owner', 'app_seam_telemetry_operator_owner', 'app_seam_telemetry_patient_owner', 'app_service', 'app_staff', 'app_tenant_service', 'app_web_push_reminder_discovery_definer', 'app_worker', 'bcb_dev', 'bcb_dev_integrator', 'bcb_dev_migrator', 'bcb_dev_runtime_nonstaff_login', 'bcb_dev_runtime_staff_login', 'bcb_dev_webapp_global_admin', 'bcb_dev_webapp_patient', 'bcb_dev_webapp_staff', 'bcb_saas_diag_test', 'bcb_saas_operator_dev', 'bcb_saas_operator_test', 'bcb_test_integrator', 'bcb_test_integrator_login', 'bcb_test_maintenance_login', 'bcb_test_migrator', 'bcb_test_nonstaff_login', 'bcb_test_operational_delivery_login', 'bcb_test_operational_diagnostic_login', 'bcb_test_operational_media_login', 'bcb_test_operational_scheduler_login', 'bcb_test_operational_web_push_reminder_login', 'bcb_test_staff_login', 'bcb_test_webapp_global_admin', 'bcb_test_webapp_patient', 'bcb_test_webapp_staff', 'bcb_test_worker_login', 'bcb_webapp_dev_user', 'bcb_webapp_prod', 'bersoncarebot_test', 'saas_system_health_owner', 'saas_telemetry_operator', 'saas_telemetry_owner']::name[]);
...
DO $bcb$ DECLARE target record; BEGIN
  FOR target IN SELECT role_name FROM bcb_zero_state_existing_roles ORDER BY role_name LOOP
    EXECUTE pg_catalog.format('ALTER ROLE %I IN DATABASE %I RESET ALL', target.role_name, 'bersoncarebot_test');
  END LOOP;
END $bcb$;

-- Preserve every object, but remove ownership, ACL and default-ACL dependencies of retired identities.
ALTER DATABASE "bersoncarebot_test" OWNER TO postgres;
REVOKE ALL PRIVILEGES ON DATABASE "bersoncarebot_test" FROM PUBLIC;
...
DO $bcb$ DECLARE grantee record; object record; schema_name name; BEGIN
  FOR grantee IN SELECT grantee_sql FROM bcb_zero_state_grantees ORDER BY role_oid LOOP
    EXECUTE pg_catalog.format('REVOKE ALL PRIVILEGES ON DATABASE %I FROM %s', 'bersoncarebot_test', grantee.grantee_sql);
...
DO $bcb$ DECLARE bad text; BEGIN
  ...
  WITH acl(grantee, owner_oid, object_name) AS (
    SELECT acl.grantee, database.datdba, 'database:' || database.datname FROM pg_catalog.pg_database database CROSS JOIN LATERAL pg_catalog.aclexplode(coalesce(database.datacl, pg_catalog.acldefault('d', database.datdba))) acl WHERE database.datname = 'bersoncarebot_test'
  ...
  WITH owner_ref(owner_oid, object_name) AS (
    SELECT database.datdba, 'database:' || database.datname FROM pg_catalog.pg_database database WHERE database.datname = 'bersoncarebot_test'
  ...
  RAISE NOTICE 'BCB_ZERO_STATE_VERIFIED database=bersoncarebot_test';
END $bcb$;
