...
node --experimental-strip-types "$repo_root/deploy/postgres/privileges/generate-cli.mjs" --shared-role-baseline \
...
assert_eq "$seam_missing_gate_execute" 33
