...
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_4" ON "public"."comments" FOR ALL USING (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (("target_type" = ANY (ARRAY['exercise', 'test', 'test_set', 'recommendation', 'lesson']::text[]) AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR ("target_type" = 'program_instance' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."treatment_program_instances" AS "b4c4_comment_program" WHERE "b4c4_comment_program"."id" = "target_id" AND "b4c4_comment_program"."patient_user_id" = app.current_patient_user_id() ))) OR ("target_type" = 'lfk_complex' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."lfk_complexes" AS "b4c4_comment_complex" WHERE "b4c4_comment_complex"."id" = "target_id" AND "b4c4_comment_complex"."platform_user_id" = app.current_patient_user_id() ))) OR ("target_type" = 'stage_instance' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."treatment_program_instance_stages" AS "b4c4_comment_stage" JOIN "public"."treatment_program_instances" AS "b4c4_comment_stage_program" ON "b4c4_comment_stage_program"."id" = "b4c4_comment_stage"."instance_id" WHERE "b4c4_comment_stage"."id" = "target_id" AND "b4c4_comment_stage_program"."patient_user_id" = app.current_patient_user_id() ))) OR ("target_type" = 'stage_item_instance' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."treatment_program_instance_stage_items" AS "b4c4_comment_stage_item" JOIN "public"."treatment_program_instance_stages" AS "b4c4_comment_item_stage" ON "b4c4_comment_item_stage"."id" = "b4c4_comment_stage_item"."stage_id" JOIN "public"."treatment_program_instances" AS "b4c4_comment_item_program" ON "b4c4_comment_item_program"."id" = "b4c4_comment_item_stage"."instance_id" WHERE "b4c4_comment_stage_item"."id" = "target_id" AND "b4c4_comment_item_program"."patient_user_id" = app.current_patient_user_id() )))))) WITH CHECK (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (("target_type" = ANY (ARRAY['exercise', 'test', 'test_set', 'recommendation', 'lesson']::text[]) AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR ("target_type" = 'program_instance' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."treatment_program_instances" AS "b4c4_comment_program" WHERE "b4c4_comment_program"."id" = "target_id" AND "b4c4_comment_program"."patient_user_id" = app.current_patient_user_id() ))) OR ("target_type" = 'lfk_complex' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."lfk_complexes" AS "b4c4_comment_complex" WHERE "b4c4_comment_complex"."id" = "target_id" AND "b4c4_comment_complex"."platform_user_id" = app.current_patient_user_id() ))) OR ("target_type" = 'stage_instance' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."treatment_program_instance_stages" AS "b4c4_comment_stage" JOIN "public"."treatment_program_instances" AS "b4c4_comment_stage_program" ON "b4c4_comment_stage_program"."id" = "b4c4_comment_stage"."instance_id" WHERE "b4c4_comment_stage"."id" = "target_id" AND "b4c4_comment_stage_program"."patient_user_id" = app.current_patient_user_id() ))) OR ("target_type" = 'stage_item_instance' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."treatment_program_instance_stage_items" AS "b4c4_comment_stage_item" JOIN "public"."treatment_program_instance_stages" AS "b4c4_comment_item_stage" ON "b4c4_comment_item_stage"."id" = "b4c4_comment_stage_item"."stage_id" JOIN "public"."treatment_program_instances" AS "b4c4_comment_item_program" ON "b4c4_comment_item_program"."id" = "b4c4_comment_item_stage"."instance_id" WHERE "b4c4_comment_stage_item"."id" = "target_id" AND "b4c4_comment_item_program"."patient_user_id" = app.current_patient_user_id() ))))));
\else
CREATE POLICY "saas_org_dormant_p0_8_4" ON "public"."comments" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (("target_type" = ANY (ARRAY['exercise', 'test', 'test_set', 'recommendation', 'lesson']::text[]) AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR ("target_type" = 'program_instance' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."treatment_program_instances" AS "b4c4_comment_program" WHERE "b4c4_comment_program"."id" = "target_id" AND "b4c4_comment_program"."patient_user_id" = app.current_patient_user_id() ))) OR ("target_type" = 'lfk_complex' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."lfk_complexes" AS "b4c4_comment_complex" WHERE "b4c4_comment_complex"."id" = "target_id" AND "b4c4_comment_complex"."platform_user_id" = app.current_patient_user_id() ))) OR ("target_type" = 'stage_instance' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."treatment_program_instance_stages" AS "b4c4_comment_stage" JOIN "public"."treatment_program_instances" AS "b4c4_comment_stage_program" ON "b4c4_comment_stage_program"."id" = "b4c4_comment_stage"."instance_id" WHERE "b4c4_comment_stage"."id" = "target_id" AND "b4c4_comment_stage_program"."patient_user_id" = app.current_patient_user_id() ))) OR ("target_type" = 'stage_item_instance' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."treatment_program_instance_stage_items" AS "b4c4_comment_stage_item" JOIN "public"."treatment_program_instance_stages" AS "b4c4_comment_item_stage" ON "b4c4_comment_item_stage"."id" = "b4c4_comment_stage_item"."stage_id" JOIN "public"."treatment_program_instances" AS "b4c4_comment_item_program" ON "b4c4_comment_item_program"."id" = "b4c4_comment_item_stage"."instance_id" WHERE "b4c4_comment_stage_item"."id" = "target_id" AND "b4c4_comment_item_program"."patient_user_id" = app.current_patient_user_id() ))))))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (("target_type" = ANY (ARRAY['exercise', 'test', 'test_set', 'recommendation', 'lesson']::text[]) AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR ("target_type" = 'program_instance' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."treatment_program_instances" AS "b4c4_comment_program" WHERE "b4c4_comment_program"."id" = "target_id" AND "b4c4_comment_program"."patient_user_id" = app.current_patient_user_id() ))) OR ("target_type" = 'lfk_complex' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."lfk_complexes" AS "b4c4_comment_complex" WHERE "b4c4_comment_complex"."id" = "target_id" AND "b4c4_comment_complex"."platform_user_id" = app.current_patient_user_id() ))) OR ("target_type" = 'stage_instance' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."treatment_program_instance_stages" AS "b4c4_comment_stage" JOIN "public"."treatment_program_instances" AS "b4c4_comment_stage_program" ON "b4c4_comment_stage_program"."id" = "b4c4_comment_stage"."instance_id" WHERE "b4c4_comment_stage"."id" = "target_id" AND "b4c4_comment_stage_program"."patient_user_id" = app.current_patient_user_id() ))) OR ("target_type" = 'stage_item_instance' AND (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."treatment_program_instance_stage_items" AS "b4c4_comment_stage_item" JOIN "public"."treatment_program_instance_stages" AS "b4c4_comment_item_stage" ON "b4c4_comment_item_stage"."id" = "b4c4_comment_stage_item"."stage_id" JOIN "public"."treatment_program_instances" AS "b4c4_comment_item_program" ON "b4c4_comment_item_program"."id" = "b4c4_comment_item_stage"."instance_id" WHERE "b4c4_comment_stage_item"."id" = "target_id" AND "b4c4_comment_item_program"."patient_user_id" = app.current_patient_user_id() )))))));
\endif
...
-- public.leads (saas_org_dormant_p0_8_3)
ALTER TABLE "public"."leads" ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "saas_org_dormant_p0_8_3" ON "public"."leads";
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_3" ON "public"."leads" FOR ALL USING ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id()))) WITH CHECK ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())));
\else
CREATE POLICY "saas_org_dormant_p0_8_3" ON "public"."leads" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR (app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR (app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id()))));
\endif
...
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_3" ON "public"."media_folders" FOR ALL USING (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (("patient_user_id" IS NULL AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND "patient_user_id" = app.current_patient_user_id())))) WITH CHECK (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (("patient_user_id" IS NULL AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND "patient_user_id" = app.current_patient_user_id()))));
\else
CREATE POLICY "saas_org_dormant_p0_8_3" ON "public"."media_folders" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (("patient_user_id" IS NULL AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND "patient_user_id" = app.current_patient_user_id()))))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (("patient_user_id" IS NULL AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND "patient_user_id" = app.current_patient_user_id())))));
\endif
...
-- public.org_custom_domain_bindings (saas_org_dormant_p0_8_3)
ALTER TABLE "public"."org_custom_domain_bindings" ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "saas_org_dormant_p0_8_3" ON "public"."org_custom_domain_bindings";
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_3" ON "public"."org_custom_domain_bindings" FOR ALL USING ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id()))) WITH CHECK ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())));
\else
CREATE POLICY "saas_org_dormant_p0_8_3" ON "public"."org_custom_domain_bindings" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR (app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR (app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id()))));
\endif
...
ALTER TABLE "public"."video_meeting_invites" ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "saas_org_dormant_p0_8_3" ON "public"."video_meeting_invites";
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_3" ON "public"."video_meeting_invites" FOR ALL USING ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id()))) WITH CHECK ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())));
\else
CREATE POLICY "saas_org_dormant_p0_8_3" ON "public"."video_meeting_invites" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR (app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR (app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id()))));
\endif

-- public.video_meetings (saas_org_dormant_p0_8_3)
ALTER TABLE "public"."video_meetings" ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "saas_org_dormant_p0_8_3" ON "public"."video_meetings";
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_3" ON "public"."video_meetings" FOR ALL USING (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND "patient_user_id" = app.current_patient_user_id()))) WITH CHECK (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND "patient_user_id" = app.current_patient_user_id())));
\else
CREATE POLICY "saas_org_dormant_p0_8_3" ON "public"."video_meetings" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND "patient_user_id" = app.current_patient_user_id())))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND "patient_user_id" = app.current_patient_user_id()))));
\endif
