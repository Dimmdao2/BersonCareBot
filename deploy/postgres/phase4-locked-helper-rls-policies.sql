...
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_5" ON "integrator"."contacts" FOR ALL USING (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND "user_id" = app.current_integrator_user_id()))) WITH CHECK (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND "user_id" = app.current_integrator_user_id())));
\else
CREATE POLICY "saas_org_dormant_p0_8_5" ON "integrator"."contacts" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND "user_id" = app.current_integrator_user_id())))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND "user_id" = app.current_integrator_user_id()))));
\endif
...
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_5" ON "integrator"."content_access_grants" FOR ALL USING (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND "user_id" = app.current_integrator_user_id()))) WITH CHECK (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND "user_id" = app.current_integrator_user_id())));
\else
CREATE POLICY "saas_org_dormant_p0_8_5" ON "integrator"."content_access_grants" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND "user_id" = app.current_integrator_user_id())))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND "user_id" = app.current_integrator_user_id()))));
\endif
...
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_5" ON "integrator"."conversations" FOR ALL USING (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."identities" AS "b4f_conversations_identity" WHERE "b4f_conversations_identity"."id" = "user_identity_id" AND "b4f_conversations_identity"."user_id" = app.current_integrator_user_id() )))) WITH CHECK (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."identities" AS "b4f_conversations_identity" WHERE "b4f_conversations_identity"."id" = "user_identity_id" AND "b4f_conversations_identity"."user_id" = app.current_integrator_user_id() ))));
\else
...
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_5" ON "integrator"."message_drafts" FOR ALL USING (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."identities" AS "b4f_message_drafts_identity" WHERE "b4f_message_drafts_identity"."id" = "identity_id" AND "b4f_message_drafts_identity"."user_id" = app.current_integrator_user_id() )))) WITH CHECK (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."identities" AS "b4f_message_drafts_identity" WHERE "b4f_message_drafts_identity"."id" = "identity_id" AND "b4f_message_drafts_identity"."user_id" = app.current_integrator_user_id() ))));
\else
CREATE POLICY "saas_org_dormant_p0_8_5" ON "integrator"."message_drafts" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."identities" AS "b4f_message_drafts_identity" WHERE "b4f_message_drafts_identity"."id" = "identity_id" AND "b4f_message_drafts_identity"."user_id" = app.current_integrator_user_id() ))))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."identities" AS "b4f_message_drafts_identity" WHERE "b4f_message_drafts_identity"."id" = "identity_id" AND "b4f_message_drafts_identity"."user_id" = app.current_integrator_user_id() )))));
\endif
...
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_5" ON "integrator"."question_messages" FOR ALL USING (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."user_questions" AS "b4f_question" JOIN "integrator"."identities" AS "b4f_ident" ON "b4f_ident"."id" = "b4f_question"."user_identity_id" WHERE "b4f_question"."id" = "question_id" AND "b4f_ident"."user_id" = app.current_integrator_user_id() )))) WITH CHECK (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."user_questions" AS "b4f_question" JOIN "integrator"."identities" AS "b4f_ident" ON "b4f_ident"."id" = "b4f_question"."user_identity_id" WHERE "b4f_question"."id" = "question_id" AND "b4f_ident"."user_id" = app.current_integrator_user_id() ))));
\else
...
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_5" ON "integrator"."user_questions" FOR ALL USING (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."identities" AS "b4f_user_questions_identity" WHERE "b4f_user_questions_identity"."id" = "user_identity_id" AND "b4f_user_questions_identity"."user_id" = app.current_integrator_user_id() )))) WITH CHECK (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."identities" AS "b4f_user_questions_identity" WHERE "b4f_user_questions_identity"."id" = "user_identity_id" AND "b4f_user_questions_identity"."user_id" = app.current_integrator_user_id() ))));
\else
CREATE POLICY "saas_org_dormant_p0_8_5" ON "integrator"."user_questions" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."identities" AS "b4f_user_questions_identity" WHERE "b4f_user_questions_identity"."id" = "user_identity_id" AND "b4f_user_questions_identity"."user_id" = app.current_integrator_user_id() ))))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."identities" AS "b4f_user_questions_identity" WHERE "b4f_user_questions_identity"."id" = "user_identity_id" AND "b4f_user_questions_identity"."user_id" = app.current_integrator_user_id() )))));
\endif
...
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_5" ON "integrator"."user_reminder_delivery_logs" FOR ALL USING (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."user_reminder_occurrences" AS "b4f_occ" JOIN "integrator"."user_reminder_rules" AS "b4f_rule" ON "b4f_rule"."id" = "b4f_occ"."rule_id" WHERE "b4f_occ"."id" = "occurrence_id" AND "b4f_rule"."user_id" = app.current_integrator_user_id() )))) WITH CHECK (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."user_reminder_occurrences" AS "b4f_occ" JOIN "integrator"."user_reminder_rules" AS "b4f_rule" ON "b4f_rule"."id" = "b4f_occ"."rule_id" WHERE "b4f_occ"."id" = "occurrence_id" AND "b4f_rule"."user_id" = app.current_integrator_user_id() ))));
\else
CREATE POLICY "saas_org_dormant_p0_8_5" ON "integrator"."user_reminder_delivery_logs" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."user_reminder_occurrences" AS "b4f_occ" JOIN "integrator"."user_reminder_rules" AS "b4f_rule" ON "b4f_rule"."id" = "b4f_occ"."rule_id" WHERE "b4f_occ"."id" = "occurrence_id" AND "b4f_rule"."user_id" = app.current_integrator_user_id() ))))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."user_reminder_occurrences" AS "b4f_occ" JOIN "integrator"."user_reminder_rules" AS "b4f_rule" ON "b4f_rule"."id" = "b4f_occ"."rule_id" WHERE "b4f_occ"."id" = "occurrence_id" AND "b4f_rule"."user_id" = app.current_integrator_user_id() )))));
\endif
...
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_5" ON "integrator"."user_reminder_occurrences" FOR ALL USING (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."user_reminder_rules" AS "b4f_rule" WHERE "b4f_rule"."id" = "rule_id" AND "b4f_rule"."user_id" = app.current_integrator_user_id() )))) WITH CHECK (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."user_reminder_rules" AS "b4f_rule" WHERE "b4f_rule"."id" = "rule_id" AND "b4f_rule"."user_id" = app.current_integrator_user_id() ))));
\else
CREATE POLICY "saas_org_dormant_p0_8_5" ON "integrator"."user_reminder_occurrences" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."user_reminder_rules" AS "b4f_rule" WHERE "b4f_rule"."id" = "rule_id" AND "b4f_rule"."user_id" = app.current_integrator_user_id() ))))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "integrator"."user_reminder_rules" AS "b4f_rule" WHERE "b4f_rule"."id" = "rule_id" AND "b4f_rule"."user_id" = app.current_integrator_user_id() )))));
\endif
...
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_3" ON "public"."be_appointment_events" FOR ALL USING (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."be_appointments" AS "b4f_appt" WHERE "b4f_appt"."id" = "appointment_id" AND "b4f_appt"."platform_user_id" = app.current_patient_user_id() )))) WITH CHECK (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."be_appointments" AS "b4f_appt" WHERE "b4f_appt"."id" = "appointment_id" AND "b4f_appt"."platform_user_id" = app.current_patient_user_id() ))));
\else
CREATE POLICY "saas_org_dormant_p0_8_3" ON "public"."be_appointment_events" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."be_appointments" AS "b4f_appt" WHERE "b4f_appt"."id" = "appointment_id" AND "b4f_appt"."platform_user_id" = app.current_patient_user_id() ))))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND EXISTS ( SELECT 1 FROM "public"."be_appointments" AS "b4f_appt" WHERE "b4f_appt"."id" = "appointment_id" AND "b4f_appt"."platform_user_id" = app.current_patient_user_id() )))));
\endif
...
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_4" ON "public"."reminder_occurrence_history" FOR ALL USING (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND "integrator_user_id" = app.current_integrator_user_id()))) WITH CHECK (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND "integrator_user_id" = app.current_integrator_user_id())));
\else
CREATE POLICY "saas_org_dormant_p0_8_4" ON "public"."reminder_occurrence_history" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND "integrator_user_id" = app.current_integrator_user_id())))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_integrator_user_id() IS NOT NULL AND "integrator_user_id" = app.current_integrator_user_id()))));
\endif
...
ALTER TABLE "public"."saas_organization_quota_usage" ENABLE ROW LEVEL SECURITY;
DROP POLICY IF EXISTS "saas_org_dormant_p0_8_3" ON "public"."saas_organization_quota_usage";
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_3" ON "public"."saas_organization_quota_usage" FOR ALL USING ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id()))) WITH CHECK ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())));
\else
CREATE POLICY "saas_org_dormant_p0_8_3" ON "public"."saas_organization_quota_usage" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR (app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR (app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id()))));
\endif
...
\if :phase4_enforce_locked_context
CREATE POLICY "saas_org_dormant_p0_8_4" ON "public"."webapp_reminder_occurrences" FOR ALL USING (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND "platform_user_id" = app.current_patient_user_id()))) WITH CHECK (((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND "platform_user_id" = app.current_patient_user_id())));
\else
CREATE POLICY "saas_org_dormant_p0_8_4" ON "public"."webapp_reminder_occurrences" FOR ALL USING (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND "platform_user_id" = app.current_patient_user_id())))) WITH CHECK (((app.current_org_id() IS NULL AND app.current_patient_user_id() IS NULL AND app.current_integrator_user_id() IS NULL AND NOT app.is_staff()) OR ((app.is_staff() AND (app.current_org_id() IS NOT NULL AND "organization_id" = app.current_org_id())) OR (app.current_patient_user_id() IS NOT NULL AND "platform_user_id" = app.current_patient_user_id()))));
\endif
