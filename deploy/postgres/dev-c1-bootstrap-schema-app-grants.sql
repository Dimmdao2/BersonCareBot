...
-- D27-C fix round 2: the bootstrap-reachable setter stamps the plaintext OTP onto a challenge row.
DO $email_challenge_delivery_code_grant$
BEGIN
  ...
  END IF;
END
$email_challenge_delivery_code_grant$;
