...
REVOKE ALL ON FUNCTION app.read_saas_isolation_events(), app.read_last_saas_isolation_coverage(), app.read_saas_isolation_trend(), app.set_saas_isolation_test_scenario(text), app.read_saas_isolation_test_scenario_fixture_counts() FROM PUBLIC;
REVOKE ALL ON FUNCTION app.record_saas_isolation_coverage(uuid,text,timestamptz,timestamptz,text[],integer,integer), app.read_saas_isolation_events(), app.read_last_saas_isolation_coverage(), app.read_saas_isolation_trend(), app.set_saas_isolation_test_scenario(text), app.read_saas_isolation_test_scenario_fixture_counts() FROM app_owner, app_staff, app_patient, app_worker;
SELECT format('REVOKE ALL ON FUNCTION app.record_saas_isolation_coverage(uuid,text,timestamptz,timestamptz,text[],integer,integer), app.read_saas_isolation_events(), app.read_last_saas_isolation_coverage(), app.read_saas_isolation_trend(), app.set_saas_isolation_test_scenario(text), app.read_saas_isolation_test_scenario_fixture_counts() FROM %I', :'telemetry_webapp_runtime_role') \gexec
SELECT format('REVOKE ALL ON FUNCTION app.record_saas_isolation_coverage(uuid,text,timestamptz,timestamptz,text[],integer,integer), app.read_saas_isolation_events(), app.read_last_saas_isolation_coverage(), app.read_saas_isolation_trend(), app.set_saas_isolation_test_scenario(text), app.read_saas_isolation_test_scenario_fixture_counts() FROM %I', :'telemetry_api_runtime_role') \gexec
SELECT format('REVOKE ALL ON FUNCTION app.report_saas_isolation_event(text,text,text,text), app.record_saas_isolation_coverage(uuid,text,timestamptz,timestamptz,text[],integer,integer), app.read_saas_isolation_events(), app.read_last_saas_isolation_coverage(), app.read_saas_isolation_trend(), app.set_saas_isolation_test_scenario(text), app.read_saas_isolation_test_scenario_fixture_counts() FROM %I', :'telemetry_operator_runtime_role') \gexec
...
GRANT EXECUTE ON FUNCTION app.record_saas_isolation_coverage(uuid,text,timestamptz,timestamptz,text[],integer,integer), app.read_saas_isolation_events(), app.read_last_saas_isolation_coverage(), app.read_saas_isolation_trend(), app.set_saas_isolation_test_scenario(text), app.read_saas_isolation_test_scenario_fixture_counts() TO saas_telemetry_operator;
...
SELECT 1 / (
  ...
  AND NOT has_function_privilege(:'telemetry_webapp_runtime_role', 'app.read_saas_isolation_test_scenario_fixture_counts()', 'EXECUTE')
