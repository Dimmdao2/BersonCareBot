...
const REV10_CONTEXT = {
  ...
  capabilities: {
    ...
    integrator_outgoing_delivery_enqueue: { port: 'integrator', runtimeName: 'outgoing_delivery_enqueue',
      ...
      functionIdentity: 'app.enqueue_integrator_outgoing_delivery(text,text,text,text,integer,timestamp with time zone,uuid,integer)' },
    ...
    webapp_platform_organization_set_active: { port: 'webapp',
      runtimeName: 'platform_organization_set_active', sessionRole: 'app_platform_settings',
      targetRole: 'app_platform_settings', contextClass: 'platform',
    ...
    webapp_media_pending_delete_step: { port: 'webapp',
      runtimeName: 'media_pending_delete_step',
      sessionRole: 'app_staff', targetRole: 'app_operational_media_worker', contextClass: 'service',
      purpose: 'media.pending-delete.step',
      functionIdentity: 'app.process_media_pending_delete_step(text,uuid,integer,uuid)' },
    ...
    email_auth_find_email_challenge_for_confirm: { port: 'webapp', sessionRole: 'app_patient',
      ...
      functionIdentity: 'app.email_auth_find_email_challenge_for_confirm(uuid,uuid)' },
    email_auth_increment_email_challenge_attempts: { port: 'webapp', sessionRole: 'app_patient',
      targetRole: 'app_pre_session', contextClass: 'pre_session',
      purpose: 'auth.email-otp.challenge.increment-attempts',
      functionIdentity: 'app.email_auth_increment_email_challenge_attempts(uuid)' },
    email_auth_find_email_owner_conflict: { port: 'webapp', sessionRole: 'app_patient',
      targetRole: 'app_pre_session', contextClass: 'pre_session',
      purpose: 'auth.email-otp.email.owner-conflict',
      functionIdentity: 'app.email_auth_find_email_owner_conflict(uuid,text)' },
    email_auth_verify_user_email: { port: 'webapp', sessionRole: 'app_patient',
      targetRole: 'app_pre_session', contextClass: 'pre_session',
      purpose: 'auth.email-otp.email.verify',
      functionIdentity: 'app.email_auth_verify_user_email(uuid,text)' },
    email_auth_delete_email_challenges_for_user: { port: 'webapp', sessionRole: 'app_patient',
      targetRole: 'app_pre_session', contextClass: 'pre_session',
      purpose: 'auth.email-otp.challenge.delete-for-user',
      functionIdentity: 'app.email_auth_delete_email_challenges_for_user(uuid)' },
    specialist_signup_intent_by_challenge: { port: 'webapp', sessionRole: 'app_patient',
      targetRole: 'app_pre_session', contextClass: 'pre_session',
      purpose: 'signup.specialist.intent.by-challenge',
      functionIdentity: 'app.get_specialist_signup_intent_by_challenge(uuid)' },
    email_password_find_user_id_by_email_challenge: { port: 'webapp', sessionRole: 'app_patient',
      targetRole: 'app_pre_session', contextClass: 'pre_session',
      purpose: 'auth.password.registration.challenge-owner',
      functionIdentity: 'app.email_password_find_user_id_by_email_challenge(uuid)' },
    email_password_delete_unverified_registration: { port: 'webapp', sessionRole: 'app_patient',
      targetRole: 'app_pre_session', contextClass: 'pre_session',
      purpose: 'auth.password.registration.delete-unverified',
      functionIdentity: 'app.email_password_delete_unverified_registration(uuid)' },
    email_password_registration_resend_candidate: { port: 'webapp', sessionRole: 'app_patient',
      targetRole: 'app_pre_session', contextClass: 'pre_session',
      purpose: 'auth.password.registration.resend-candidate',
      functionIdentity: 'app.email_password_find_login_candidate(text)' },
    email_password_register_pending: { port: 'webapp', sessionRole: 'app_patient',
      targetRole: 'app_pre_session', contextClass: 'pre_session',
      purpose: 'auth.password.registration.create',
      functionIdentity: 'app.email_password_register_pending(text,text,text,text,text,text)' },
  ...
  functions: applyTenantWallCrossings(applyRowLockSurfaces(applyCanonicalContactSurfaceCorrections({
    ...
    'app.email_auth_find_email_owner_conflict(uuid,text)': {
      ...
      execute: ['app_pre_session'], purpose: 'auth.email-otp.email.owner-conflict',
      relationSurfaces: [],
    ...
    'app.read_platform_analytics_dashboard(timestamp with time zone,timestamp with time zone,text,text)': rev10Function({
      ...
      relationSurfaces: [
        ...
        { relation: 'public.be_specialists', columns: ['created_at', 'is_active'],
          operations: ['SELECT' as const], evidence: 'pg16-function-body-lexical-upper-bound' as const },
        { relation: 'public.platform_users', columns: ['id', 'role', 'merged_into_id', 'is_archived', 'created_at'],
          operations: ['SELECT' as const], evidence: 'pg16-function-body-lexical-upper-bound' as const },
        ...
        { relation: 'public.symptom_trackings', columns: ['id', 'symptom_key'],
          operations: ['SELECT' as const], evidence: 'pg16-function-body-lexical-upper-bound' as const },
        { relation: 'public.media_playback_resolution_events', columns: ['resolved_at', 'user_id', 'media_id'],
          operations: ['SELECT' as const], evidence: 'pg16-function-body-lexical-upper-bound' as const },
    ...
    'app.enqueue_integrator_outgoing_delivery(text,text,text,text,integer,timestamp with time zone,uuid,integer)': rev10Function({
      ...
      purpose: 'enqueue one integrator-owned outgoing delivery and prune expired sent rows',
      typedArgs: ['text', 'text', 'text', 'text', 'integer', 'timestamp with time zone', 'uuid', 'integer'], volatility: 'VOLATILE', parallel: 'UNSAFE',
      proconfig: ['search_path=pg_catalog, app, public, pg_temp'],
    ...
    // Delegated identity lookup: both callers are SECURITY DEFINER wrappers, so the EXECUTE check
    // inside them is against the WRAPPER OWNER, never against the session role that entered the
    // wrapper.  Without the owners here the wrapper reaches its second statement and dies 42501.
    'app.find_platform_user_ids_by_any_confirmed_email(text)': {
      ...BUSINESS_SEAM_FUNCTIONS['app.find_platform_user_ids_by_any_confirmed_email(text)'],
      execute: [
    ...
    'app.email_auth_increment_email_challenge_attempts(uuid)': {
      ...BUSINESS_SEAM_FUNCTIONS['app.email_auth_increment_email_challenge_attempts(uuid)'],
      execute: ['app_pre_session'], purpose: 'auth.email-otp.challenge.increment-attempts',
    },
    'app.email_auth_verify_user_email(uuid,text)': {
      ...BUSINESS_SEAM_FUNCTIONS['app.email_auth_verify_user_email(uuid,text)'],
      execute: ['app_pre_session'], purpose: 'auth.email-otp.email.verify',
    },
    'app.email_auth_delete_email_challenges_for_user(uuid)': {
      ...BUSINESS_SEAM_FUNCTIONS['app.email_auth_delete_email_challenges_for_user(uuid)'],
      execute: ['app_pre_session'], purpose: 'auth.email-otp.challenge.delete-for-user',
    },
    'app.get_specialist_signup_intent_by_challenge(uuid)': {
      ...BUSINESS_SEAM_FUNCTIONS['app.get_specialist_signup_intent_by_challenge(uuid)'],
      execute: ['app_pre_session'], purpose: 'signup.specialist.intent.by-challenge',
    },
    'app.email_password_find_user_id_by_email_challenge(uuid)': {
      ...BUSINESS_SEAM_FUNCTIONS['app.email_password_find_user_id_by_email_challenge(uuid)'],
      execute: ['app_pre_session'], purpose: 'auth.password.registration.challenge-owner',
    },
    'app.email_password_delete_unverified_registration(uuid)': {
      ...BUSINESS_SEAM_FUNCTIONS['app.email_password_delete_unverified_registration(uuid)'],
      execute: ['app_pre_session'], purpose: 'auth.password.registration.delete-unverified',
    },
    'app.email_password_find_login_candidate(text)': {
      ...BUSINESS_SEAM_FUNCTIONS['app.email_password_find_login_candidate(text)'],
      execute: ['app_pre_session'], purpose: 'auth.password.registration.resend-candidate',
    },
    'app.email_password_register_pending(text,text,text,text,text,text)': {
      ...BUSINESS_SEAM_FUNCTIONS['app.email_password_register_pending(text,text,text,text,text,text)'],
      execute: ['app_pre_session'], purpose: 'auth.password.registration.create',
    },
    ...
    'app.email_otp_public_find_or_create_user(text)': rev10Function({
      ...
      relationSurfaces: [{ relation: 'public.platform_users',
        columns: ['id', 'display_name', 'role', 'created_at', 'merged_into_id'],
    ...
    'app.email_otp_public_find_user_by_email(text)': rev10Function({
      ...
      volatility: 'STABLE', parallel: 'UNSAFE', proconfig: ['search_path=pg_catalog'],
      relationSurfaces: [{ relation: 'public.platform_users',
        columns: ['id', 'merged_into_id'], operations: ['SELECT'],
        evidence: 'pg16-function-body-lexical-upper-bound' }],
    }),
    ...
    'app.resolve_public_booking_client_by_phone(text,text,boolean)': rev10Function({
      ...
      relationSurfaces: [
        ...
        { relation: 'public.user_identity', columns: ['platform_user_id', 'first_name', 'last_name',
          'patronymic', 'display_name', 'updated_at'],
          operations: ['SELECT' as const, 'INSERT' as const, 'UPDATE' as const],
          evidence: 'pg16-function-body-lexical-upper-bound' as const },
      ],
    }),
    ...
    'app.process_media_pending_delete_step(text,uuid,integer,uuid)': rev10Function({
      ...
      purpose: 'media.pending-delete.step', typedArgs: ['text', 'uuid', 'integer', 'uuid'],
      volatility: 'VOLATILE',
      parallel: 'UNSAFE', proconfig: ['search_path=pg_catalog'],
      relationSurfaces: [
        { relation: 'public.media_files',
        ...
        { relation: 'public.treatment_program_instance_stage_items',
          ...
          evidence: 'pg16-function-body-lexical-upper-bound' as const },
        { relation: 'public.media_upload_sessions',
          columns: ['id', 'media_id', 's3_key', 'upload_id', 'status'],
          operations: ['SELECT' as const], evidence: 'pg16-function-body-lexical-upper-bound' as const },
        { relation: 'public.patient_files', columns: ['media_file_id'],
          operations: ['SELECT' as const, 'DELETE' as const],
          evidence: 'pg16-function-body-lexical-upper-bound' as const },
      ],
    }),
    ...
    'app.pre_session_phone_confirm_resolve(text,text,boolean,text)': rev10Function({
      ...
      relationSurfaces: [
        ...
        { relation: 'public.user_contacts',
          ...
          evidence: 'pg16-function-body-lexical-upper-bound' as const },
        { relation: 'public.user_identity',
          columns: ['platform_user_id', 'first_name', 'last_name', 'patronymic', 'display_name', 'updated_at'],
          operations: ['SELECT' as const, 'INSERT' as const, 'UPDATE' as const, 'DELETE' as const],
          evidence: 'pg16-function-body-lexical-upper-bound' as const },
        { relation: 'public.user_phone_history',
    ...
    'app.set_platform_organization_is_active(uuid,boolean)': rev10Function({
      ...
      purpose: 'set whether a platform organization account is enabled',
      typedArgs: ['uuid', 'boolean'], volatility: 'VOLATILE', parallel: 'UNSAFE',
      proconfig: ['search_path=pg_catalog'],
      relationSurfaces: [{ relation: 'public.be_organizations',
