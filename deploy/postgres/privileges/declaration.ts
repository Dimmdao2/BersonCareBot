    ...
    'app.archive_operator_health_failures(text,integer,uuid)': rev10Function({
      ...
      relationSurfaces: [
        { relation: 'public.outgoing_delivery_queue', columns: ['id', 'organization_id', 'status', 'failure_class',
          'kind', 'channel', 'payload_json', 'last_error', 'created_at'], operations: ['SELECT' as const, 'DELETE' as const],
          evidence: 'pg16-function-body-lexical-upper-bound' as const },
        { relation: 'public.outgoing_delivery_queue', columns: ['id'], operations: ['UPDATE' as const],
          evidence: 'FOR UPDATE SKIP LOCKED requires column update privilege' as const },
        ...
        { relation: 'public.integrator_push_outbox', columns: ['id', 'kind', 'status', 'last_error',
          ...
          evidence: 'pg16-function-body-lexical-upper-bound' as const },
        { relation: 'public.integrator_push_outbox', columns: ['id'], operations: ['UPDATE' as const],
          evidence: 'FOR UPDATE SKIP LOCKED requires column update privilege' as const },
        { relation: 'integrator.projection_outbox', columns: ['id', 'event_type', 'idempotency_key',
          ...
          evidence: 'pg16-function-body-lexical-upper-bound' as const },
        { relation: 'integrator.projection_outbox', columns: ['id'], operations: ['UPDATE' as const],
          evidence: 'FOR UPDATE SKIP LOCKED requires column update privilege' as const },
