...
overview: "Очередь: фазы 0–1 и 2A–2C закрыты (2026-06-02); следующая — 3 (черновик редактора), затем 4–6."
todos:
...
## Фаза 3 — Редактор назначенной программы: черновик + save — **следующая**
