...
overview: Выровнять справочник load_type с lfk_exercises.load_type; UI и валидация через references + сид v1. Закрыто 2026-05-04; канон и пост-аудит — docs/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/EXERCISE_LOAD_TYPE_FROM_REFS_PLAN.md
todos:
...
**[`docs/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/EXERCISE_LOAD_TYPE_FROM_REFS_PLAN.md`](../../docs/ASSIGNMENT_CATALOGS_REWORK_INITIATIVE/EXERCISE_LOAD_TYPE_FROM_REFS_PLAN.md)**
