 ...
 *
 * Использование:
 *   DATABASE_URL=... pnpm exec tsx scripts/user-phone-admin.ts info 79189000782
 *   DATABASE_URL=... pnpm exec tsx scripts/user-phone-admin.ts reset-user 79189000782
 *   DATABASE_URL=... pnpm exec tsx scripts/user-phone-admin.ts reassign-user 79189000782 05f08456-...
 */
