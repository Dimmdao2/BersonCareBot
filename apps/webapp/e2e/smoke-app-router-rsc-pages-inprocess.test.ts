...
const LOADERS = {
  ...
  doctorSubscriberProfile: () =>
    import('@/app/app/doctor/subscribers/[userId]/page') as Promise<PageMod>,
  ...
  patientDiaryLfkJournal: () =>
    import('@/app/app/patient/diary/lfk/journal/page') as Promise<PageMod>,
  patientDiarySymptomsJournal: () =>
    import('@/app/app/patient/diary/symptoms/journal/page') as Promise<PageMod>,
  ...
  doctorContentMotivation: () =>
    import('@/app/app/doctor/content/motivation/page') as Promise<PageMod>,
  ...
  doctorMaterialRatingDetail: () =>
    import('@/app/app/doctor/material-ratings/[kind]/[id]/page') as Promise<PageMod>,
