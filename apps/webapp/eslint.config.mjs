        ...
        'error',
        {
          patterns: [
            ...
            },
            {
              group: ['@/infra/repos/*'],
              message:
                'modules must not import infra/repos directly. Define port in modules/*/ports.ts, implement in infra/repos, inject via buildAppDeps.',
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              group: ['@/infra/db/*', '@/infra/db/client'],
              message:
                'Route handlers must not import infra/db directly. Use @/app-layer/db/client, buildAppDeps(), or another app-layer facade.',
            },
            {
              group: ['@/infra/repos/*'],
              message:
                'Route handlers must not import infra/repos directly. Use services via buildAppDeps() or app-layer facades.',
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              ...
              message:
                'Patient zone must not import doctor shared UI. Use @/shared/ui/patient/** instead.',
            },
            {
              group: ['@/components/ui/**'],
              message:
                'Patient zone must use @/shared/ui/patient/primitives/** instead of @/components/ui/**.',
            },
          ],
        },
      ],
          ...
          patterns: [
            {
              ...
              message:
                'Doctor zone must not import patient shared UI. Use @/shared/ui/doctor/** instead.',
            },
            {
              group: ['@/components/ui/**'],
              message:
                'Doctor zone must use @/shared/ui/doctor/primitives/** instead of @/components/ui/**.',
            },
          ],
        },
      ],
