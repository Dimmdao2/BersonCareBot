...
self.addEventListener('notificationclick', (event) => {
  ...
  if (action === 'snooze' && notifData.occurrenceId) {
    event.waitUntil(
      fetch(
        `/api/patient/reminders/occurrences/${encodeURIComponent(notifData.occurrenceId)}/snooze`,
        {
          method: 'POST',
          credentials: 'include',
        },
  ...
  if (action === 'skip' && notifData.occurrenceId) {
    event.waitUntil(
      fetch(
        `/api/patient/reminders/occurrences/${encodeURIComponent(notifData.occurrenceId)}/skip`,
        {
          method: 'POST',
          credentials: 'include',
        },
