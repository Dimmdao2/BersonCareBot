...
Live DEV/TEST fixture machinery and fixture-dependent named-DEV runner were removed 21.08.2026. Do not create,
seed, reconcile or require persistent fixture clinics, users or datasets; use the already registered owner accounts
and clinics under `AGENTS.md` §1b.
