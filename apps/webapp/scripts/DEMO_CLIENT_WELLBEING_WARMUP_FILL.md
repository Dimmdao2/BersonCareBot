...
- самочувствию после разминки (`warmup_feeling` в `symptom_entries`; в продукте допустимы только **1 / 3 / 5**, в этом демо-наборе — только **3 и 5**),
...
WITH warmup_plan(completed_at, feeling) AS (
  VALUES
    ...
    ('2026-04-28T10:11:00+03'::timestamptz, 3),
    ('2026-04-29T08:47:00+03'::timestamptz, 5),
    ('2026-04-30T09:25:00+03'::timestamptz, 3),
    ('2026-04-30T20:06:00+03'::timestamptz, 3),
    ...
    ('2026-05-07T09:13:00+03'::timestamptz, 3),
