...
/**
 * Organization-scope predicate for `lfk_exercises`/related tables.
 *
...
function mapExerciseRow(row: ExerciseDbRow, media: ExerciseMedia[]): Exercise {
 ...
 * (`apps/media-worker`, очередь превью) — тот же, что делает превью загруженным файлам.
 *
