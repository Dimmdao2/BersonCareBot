...
describe("createPgTestSetsPort usage summary", () => {
  beforeEach(() => {
    ...
    rootRowsMock.mockReturnValue([{ id: "00000000-0000-4000-8000-000000000088" }]);
  });
  ...
  it("does not load usage refs when the requested test set is foreign or NULL-owned", async () => {
    rootRowsMock.mockReturnValue([]);
    const port = createPgTestSetsPort();
    await expect(port.getTestSetUsageSummary("00000000-0000-4000-8000-000000000088")).resolves.toMatchObject({
