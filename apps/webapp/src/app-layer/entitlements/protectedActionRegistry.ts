...
export const PROTECTED_ACTION_MAPPINGS = [
  ...
  { id: "clinic-team.invites.create", mechanic: "clinic_team", file: "src/app/api/clinic/invites/route.ts", exportName: "POST", method: "POST", authContext: "requireClinicManagementApiContext", guard: "requireEntitlement", serviceBoundary: "deps.clinicSeats.assertSeatAvailableForInvite/deps.organizationInvites.createInvite" },
