...
export const PROTECTED_ACTION_MAPPINGS = [
  ...
  {
    id: 'patient-diaries.mood.submit',
    ...
    authContext: 'requirePatientApiBusinessAccess + resolvePatientEnrollmentOrganizationId',
    guard: 'requireEntitlementForMutation',
    serviceBoundary: 'deps.patientMood.submitScore',
  },
  {
    id: 'patient-diaries.warmup-feeling.update',
    mechanic: 'patient_diaries',
  ...
  {
    id: 'patient-diaries.lfk.doctor-comment.update',
    mechanic: 'patient_diaries',
    ...
    authContext: 'requireDoctorWorkspaceApiContext',
    guard: 'requireEntitlementForMutation',
    serviceBoundary: 'deps.diaries.updateLfkComplexExerciseLocalCommentForUser',
  },
  {
    id: 'patient-diaries.purge',
    mechanic: 'patient_diaries',
    ...
    authContext: 'requirePatientApiBusinessAccess + resolvePatientEnrollmentOrganizationId',
    guard: 'requireEntitlementForMutation',
    serviceBoundary: 'deps.diaries.purgeAllDiaryDataForUser',
  },
  {
  ...
  },
  {
    ...
    authContext: 'requirePatientAccessWithPhone + resolvePatientEnrollmentOrganizationId',
    guard: 'requireEntitlementForMutation',
    serviceBoundary: 'deps.diaries.updateSymptomEntry',
  },
  {
    id: 'patient-diaries.symptoms.delete',
    mechanic: 'patient_diaries',
    file: 'src/app/app/patient/diary/symptoms/actions.ts',
    ...
    authContext: 'requirePatientAccessWithPhone + resolvePatientEnrollmentOrganizationId',
    guard: 'requireEntitlementForMutation',
    serviceBoundary: 'deps.diaries.deleteSymptomEntry',
  },
  {
    id: 'patient-diaries.lfk.create',
    mechanic: 'patient_diaries',
    ...
    authContext: 'requirePatientAccessWithPhone + resolvePatientEnrollmentOrganizationId',
    guard: 'requireEntitlementForMutation',
    serviceBoundary: 'deps.diaries.addLfkSession',
  },
  {
    id: 'patient-diaries.lfk.update',
    mechanic: 'patient_diaries',
    file: 'src/app/app/patient/diary/lfk/actions.ts',
    ...
    authContext: 'requirePatientAccessWithPhone + resolvePatientEnrollmentOrganizationId',
    guard: 'requireEntitlementForMutation',
    serviceBoundary: 'deps.diaries.updateLfkSession',
  },
  {
    id: 'patient-diaries.lfk.delete',
    mechanic: 'patient_diaries',
    file: 'src/app/app/patient/diary/lfk/actions.ts',
    ...
    authContext: 'requirePatientAccessWithPhone + resolvePatientEnrollmentOrganizationId',
    guard: 'requireEntitlementForMutation',
    serviceBoundary: 'deps.diaries.deleteLfkSession',
  },
  {
