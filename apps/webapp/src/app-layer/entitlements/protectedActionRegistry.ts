...
export const PROTECTED_ACTION_MAPPINGS = [
  ...
  {
    id: 'booking.policies.upsert',
    mechanic: 'booking',
    file: 'src/app/api/admin/booking-engine/policies/route.ts',
    exportName: 'POST',
    method: 'POST',
    authContext: 'requireClinicManagementBookingEngine',
    guard: 'requireEntitlementForMutation',
  ...
  {
    id: 'booking.scheduling-settings.update',
    mechanic: 'booking',
    file: 'src/app/api/admin/booking-engine/scheduling-settings/route.ts',
    exportName: 'PUT',
    method: 'PUT',
    authContext: 'requireAdminBookingEngine',
    guard: 'requireEntitlementForMutation',
    serviceBoundary:
      'bookingScheduling.upsertBufferMinutes + systemSettings.updateSetting(booking_min_notice_hours|booking_max_consecutive_slot_hours)',
  },
  {
    id: 'booking.specialist-rooms.set',
    mechanic: 'booking',
    file: 'src/app/api/admin/booking-engine/specialist-rooms/route.ts',
    exportName: 'POST',
    method: 'POST',
    authContext: 'requireAdminBookingEngine',
    guard: 'requireEntitlementForMutation',
    serviceBoundary: 'gate.ctx.service.catalog.setSpecialistRoom',
  },
  {
    id: 'booking.organization.upsert',
    mechanic: 'booking',
    file: 'src/app/api/admin/booking-engine/organizations/route.ts',
    exportName: 'POST',
    method: 'POST',
    authContext: 'requireAdminBookingEngine',
    guard: 'requireEntitlementForMutation',
    serviceBoundary: 'gate.ctx.service.organization.upsertOrganization',
  },
  {
