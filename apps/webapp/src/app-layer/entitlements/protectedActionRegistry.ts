...
export const PROTECTED_ACTION_MAPPINGS = [
  ...
  {
    id: 'booking.form-fields.list',
    mechanic: ['booking', 'leads'],
    file: 'src/app/api/admin/booking-engine/form-fields/route.ts',
    exportName: 'GET',
    method: 'GET',
    authContext: 'requireClinicManagementBookingEngine',
    guard: 'requireEntitlementForRead',
    serviceBoundary: 'bookingForm.listAdminFields',
  },
  {
  ...
  },
  {
    ...
    authContext: 'requireClinicManagementApiContext',
    guard: 'requireEntitlementForMutation',
    serviceBoundary: 'leads.setStatus/archive/unarchive',
  },
  {
  ...
  {
    id: 'doctor-statistics.analytics-records.read',
    mechanic: 'doctor_statistics',
    file: 'src/app/api/doctor/analytics/records/route.ts',
    exportName: 'GET',
    method: 'GET',
    authContext: 'requireDoctorWorkspaceApiContext',
    guard: 'requireEntitlementForRead',
    serviceBoundary: 'deps.doctorAppointments.getScheduleKpis+getAppointmentDailySeries',
  },
  {
    id: 'doctor-statistics.analytics-records-drilldown.read',
    mechanic: 'doctor_statistics',
    file: 'src/app/api/doctor/analytics/records/drilldown/route.ts',
    exportName: 'GET',
    method: 'GET',
    authContext: 'requireDoctorWorkspaceApiContext',
    guard: 'requireEntitlementForRead',
    serviceBoundary: 'deps.doctorAppointments.listAppointmentsForSpecialist',
  },
  {
    id: 'doctor-statistics.analytics-activity.read',
    mechanic: 'doctor_statistics',
    file: 'src/app/api/doctor/analytics/activity/route.ts',
    exportName: 'GET',
    method: 'GET',
    authContext: 'requireDoctorWorkspaceApiContext',
    guard: 'requireEntitlementForRead',
    serviceBoundary: 'deps.doctorProgramActivity.getActivityKpis+getActivityDailySeries',
  },
  {
    id: 'doctor-statistics.analytics-activity-drilldown.read',
    mechanic: 'doctor_statistics',
    file: 'src/app/api/doctor/analytics/activity/drilldown/route.ts',
    exportName: 'GET',
    method: 'GET',
    authContext: 'requireDoctorWorkspaceApiContext',
    guard: 'requireEntitlementForRead',
    serviceBoundary: 'deps.doctorProgramActivity.listPatientsWithActivity',
  },
  {
