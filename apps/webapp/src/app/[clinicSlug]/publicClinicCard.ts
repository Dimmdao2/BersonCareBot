 ...
 *
 * Отказ намеренно неразличим по причинам: клиники нет в публичном каталоге, человека не существует,
 * он неактивен или клиника его не публикует — всё это `absent`, то есть 404. Различать причины
 * публично значило бы дать анониму перебирать и клиники, и людей по форме ответа (план §3.3).
 *
