 ...
 *   • нет клиники / её страница выключена / человека нет / он неактивен / клиника его не
 *     публикует → ОДИН И ТОТ ЖЕ `404`, иначе аноним перебирает клиники и людей по форме ответа;
