...
export function BookingCatalogProductsSection({
  ...
  function save() {
    ...
    const validity = validityDays.trim() === '' ? null : Number.parseInt(validityDays, 10);
        ...
        <ul className="text-sm">
          {products.map((p) => (
            ...
            >
              <span>
                {p.title} —{' '}
                {TYPE_LABELS[p.productType as keyof typeof TYPE_LABELS] ?? p.productType} —{' '}
