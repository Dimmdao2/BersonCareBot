  ...
  return (
    <>
      ...
      >
        ...
        <p>
          Мы очень хотим, чтобы у вас всё заработало. Похоже, приложению не удалось запуститься — возможно,
          стоит обновить браузер, операционную систему или попробовать открыть с другого устройства. Если не
          получится — напишите нам, мы поможем.
        </p>
        <a className={cn(patientInlineLinkClass, "font-medium underline")} href={supportContactHref}>
