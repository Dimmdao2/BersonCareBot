...
describe('DoctorCalendarEventPanel patient heading', () => {
  ...
  it('leaves close to the dialog host when the panel close is disabled', async () => {
    render(
      <DoctorCalendarEventPanel {...commonProps} selected={baseEvent} showCloseControl={false} />,
    );
    expect(
  ...
  it('submits a new-patient draft through the atomic patient-visit endpoint', async () => {
    render(
      <DoctorCalendarEventPanel
        ...
        filterMeta={{
          specialists: [{ id: '33333333-3333-4333-8333-333333333333', label: 'Специалист' }],
          branches: [{ id: '11111111-1111-4111-8111-111111111111', label: 'Филиал' }],
          rooms: [],
          services: [
            {
