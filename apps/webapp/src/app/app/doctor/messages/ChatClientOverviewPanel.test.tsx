...
describe("ChatClientOverviewPanel — data wiring", () => {
  ...
  it("splits a past visit into 'История записи' and shows an empty state for 'Активные записи'", async () => {
    ...
    render(
      <ChatClientOverviewPanel patientUserId={PATIENT_USER_ID} patientDisplayName="Пациент" onClose={vi.fn()} />,
    );
  ...
  it("calls onClose when the × button is clicked", async () => {
    ...
    render(
      <ChatClientOverviewPanel patientUserId={PATIENT_USER_ID} patientDisplayName="Пациент" onClose={onClose} />,
    );
