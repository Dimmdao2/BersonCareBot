...
- На мобильном таб-полоса заменена тремя действиями в шапке: записи, график работы и настройки.
  Тулбар записей фиксирован сразу под шапкой, а time-grid занимает пространство до нижней навигации без
  ...
  Месячный режим использует вертикальную ленту месяцев с тем же ленивым расширением диапазона; позиция даты
  сохраняется при переключении «3 дня ↔ месяц». «Сегодня» и выбор даты возвращают оба режима к нужному дню.
