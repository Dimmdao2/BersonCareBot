 ...
 */
export function firstSnapshotMedia(snapshot: Record<string, unknown>): ExerciseCommentThumbMedia | null {
...
export function thumbToExerciseMedia(thumb: ExerciseCommentThumbMedia | null | undefined): ExerciseMedia | null {
