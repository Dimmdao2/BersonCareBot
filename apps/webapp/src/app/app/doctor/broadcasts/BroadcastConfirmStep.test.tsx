...
describe('BroadcastConfirmStep', () => {
  it('shows audience size from preview', () => {
    ...
    expect(document.getElementById('broadcast-channels-summary')).toHaveTextContent(
      /сообщение в боте/i,
    );
    ...
    expect(document.getElementById('broadcast-delivery-policy')).toHaveTextContent(
      policy.descriptionRu,
    );
  });
