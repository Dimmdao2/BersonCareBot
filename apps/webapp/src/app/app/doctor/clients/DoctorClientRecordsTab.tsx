    ...
    <div className="flex flex-col gap-0">
      ...
      <section id="doctor-client-section-appointments" className={doctorClientTabSectionClass}>
        <div className="flex flex-col gap-3">
          {upcomingAppointments.length === 0 ? (
            ...
            <ul
              id="doctor-client-upcoming-appointments-list"
          ...
          <p className="text-xs font-medium uppercase tracking-wide text-muted-foreground">
            Статистика: всего {appointmentStats.total}, отмен за 30 дн.:{' '}
            {appointmentStats.cancellations30d}
          </p>
        </div>
      </section>

      <section
        id="doctor-client-section-appointment-history"
        ...
        <details className="group">
          ...
          <div className="mt-3">
            {appointmentHistory.length === 0 ? (
              ...
              <ul
                id="doctor-client-appointment-history-list"
                className="m-0 list-none space-y-3 p-0"
              >
      ...
      <section id="doctor-client-section-symptoms" className={doctorClientTabSectionClass}>
        {symptomTrackings.length === 0 ? (
          ...
          <>
            <p className="text-sm">
              Симптомы: {symptomTrackings.map((t) => t.symptomTitle).join(', ')}
            </p>
