...
export const DOCTOR_CLIENT_PENDING_TESTS_SECTION_ANCHOR =
  'doctor-client-section-pending-program-tests';

export type DoctorClientProfileScope = 'appointments' | 'all' | 'archived';

export function normalizeDoctorClientProfileScope(
  scope: string | undefined,
): DoctorClientProfileScope {
