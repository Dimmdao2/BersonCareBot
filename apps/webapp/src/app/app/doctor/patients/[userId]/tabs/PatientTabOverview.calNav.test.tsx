...
describe('PatientTabOverview — calendar month navigation', () => {
  ...
  async function renderComponent() {
    const { PatientTabOverview } =
      await import('@/app/app/doctor/patients/[userId]/tabs/PatientTabOverview');
  ...
  it('fetches exercise-calendar with current month from/to on mount', async () => {
    ...
    await waitFor(() => {
      const calCalls = (fetchMock.mock.calls as [string, RequestInit | undefined][]).filter(([u]) =>
        u.includes('exercise-calendar'),
      );
