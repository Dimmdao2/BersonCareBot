  ...
  it.each([
    ...
    [
      ...
      () =>
        attachArticleSectionToSystemFolder(
          null,
          formWith({ section_slug: 'new', system_parent_code: 'sos' }),
        ),
      updateMock,
    ],
    [
      ...
      () =>
        renameContentSectionSlug(
          null,
          formWith({ old_slug: 'old', new_slug: 'new', confirm_rename: 'on' }),
        ),
      renameSectionSlugMock,
    ],
    [
      'delete',
      () => deleteContentSection(null, formWith({ section_slug: 'old', confirm_delete: 'on' })),
      deleteSectionWithPageReassignMock,
    ],
