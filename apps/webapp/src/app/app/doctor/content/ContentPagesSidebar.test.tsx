...
describe('ContentPagesSidebar', () => {
  ...
  it('renders motivation, sections, articles, system folders without library link', () => {
    ...
    expect(screen.getByRole('link', { name: 'Мотивации' })).toHaveAttribute(
      'href',
      '/app/doctor/content/motivation',
    );
    expect(screen.getByRole('link', { name: 'Разделы' })).toHaveAttribute(
      'href',
      '/app/doctor/content/sections',
    );
    expect(screen.getByRole('link', { name: 'Все страницы' })).toHaveAttribute(
      'href',
      '/app/doctor/content',
    );
    ...
    expect(screen.getByRole('link', { name: 'SOS' })).toHaveAttribute(
      'href',
      '/app/doctor/content?systemParentCode=sos',
    );
