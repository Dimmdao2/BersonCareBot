...
export function PatientPlanTodayRemindersCard({
  ...
  return (
    <div
      className={cn(
        patientSurfaceInfoClass,
        "mt-4 flex flex-col gap-2 border-[#fef3c7] bg-[linear-gradient(135deg,#fff9f0_0%,#fff6e8_48%,#fffbeb_100%)] text-[var(--patient-text-primary)]",
      )}
    >
      <h2 className={patientSectionTitleNormalClass}>Напоминания на сегодня</h2>
