...
const principalContexts = vi.hoisted(() => [] as Array<{ organizationId: string; platformUserId: string }>);
...
async function renderArticle() {
  render(await PatientContentSlugArticle({
    slug: "material",
...
describe("PatientContentSlugArticle course CTA boundary", () => {
  ...
  ])("does not expose the CTA without both enrollment and entitlement", async ({ enrollment, entitlement }) => {
