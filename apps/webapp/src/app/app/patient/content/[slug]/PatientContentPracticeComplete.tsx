      ...
      <section id="patient-content-practice-complete" className={patientSurfaceSuccessClass}>
        <div className="flex items-center gap-2">
          <CheckCircle2
            ...
            aria-hidden
          />
          <p className={cn(patientBodyTextClass, 'text-[var(--patient-surface-success-text)]')}>
    ...
    <>
      <section id="patient-content-practice-complete" className={patientCardClass}>
        <Button
          ...
          onClick={() =>
            void (isWarmup ? postWarmupCompletionThenOpenModal() : setDialogOpen(true))
          }
        >
        ...
        footer={
          !isWarmup ? (
            <Button
              ...
              disabled={submitting}
              className={cn(
                'px-4 py-2 text-[var(--patient-text-muted)]',
                patientActionTextClass,
