  ...
  return (
    <DoctorSection id="platform-integration-availability">
      ...
      <p className="text-sm text-muted-foreground">
        ...
        должна показываться и настраиваться в организации. Включение разрешает будущий экран
        настройки, но не выдаёт организации платформенные секреты и не обходит тариф: собственные
        креды организация добавляет локально, когда тариф это разрешает.
      </p>
      {availability ? (
