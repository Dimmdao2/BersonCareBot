...
export default function EmailSetupPageClient({ initialToken }: Props) {
  ...
  return (
    ...
    >
      <section
        id="email-setup-section"
        className={cn(patientCardClass, 'flex flex-col gap-4 pb-24')}
      >
        ...
        {pageState.kind === 'missing_token' ? (
          <>
            ...
            <p className={patientMutedTextClass}>
              Откройте ссылку из письма или запросите новую у специалиста.
            </p>
          </>
        ) : null}
        ...
        {pageState.kind === 'ready' ? (
          <>
            ...
            <p className={patientMutedTextClass}>
              Подтвердите email и задайте пароль для входа в кабинет.
            </p>
          ...
          <>
            ...
            {pageState.kind === 'expired' ? (
              ...
              <p className={patientMutedTextClass}>
                ...
                <span className="font-medium text-foreground">{pageState.email}</span>. Проверьте
                почту.
              </p>
            )}
