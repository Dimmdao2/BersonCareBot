...
describe("doctor catalog API principal routes", () => {
  ...
  it("wraps treatment program template API writes in doctor workspace principal", () => {
    ...
    const groupsReorder = readRoute("./treatment-program-templates/stages/[stageId]/groups/reorder/route.ts");
    ...
    const itemsReorder = readRoute("./treatment-program-templates/stages/[stageId]/items/reorder/route.ts");
    const itemRoute = readRoute("./treatment-program-templates/stage-items/[itemId]/route.ts");
    const expandLfk = readRoute("./treatment-program-templates/stages/[stageId]/items/from-lfk-complex/route.ts");
    const expandTestSet = readRoute("./treatment-program-templates/stages/[stageId]/items/from-test-set/route.ts");
    ...
    expect(expandTestSet).toContain("doctor.treatment-program-templates.stage-items.expand-test-set");
  });
});
