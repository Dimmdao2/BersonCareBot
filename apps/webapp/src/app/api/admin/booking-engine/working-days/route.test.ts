...
describe('/api/admin/booking-engine/working-days', () => {
  ...
  describe('GET', () => {
    it('returns 401 when not authenticated', async () => {
      ...
      const res = await GET(
        new Request(
          'http://localhost/api/admin/booking-engine/working-days?dateFrom=2026-06-01&dateTo=2026-06-30',
        ),
      );
    ...
    it('resolves __none__ specialistId to null', async () => {
      ...
      await GET(
        new Request(
          'http://localhost/api/admin/booking-engine/working-days?dateFrom=2026-06-01&dateTo=2026-06-30&specialistId=__none__',
        ),
      );
      expect(listWorkingDaysMock).toHaveBeenCalledWith(
