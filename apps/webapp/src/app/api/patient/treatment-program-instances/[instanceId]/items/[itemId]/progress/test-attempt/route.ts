...
export async function POST(
  ...
  try {
    const attempt = await deps.treatmentProgramProgress.patientEnsureTestAttempt({
    ...
    return respondWithSafeApiError(
      'api/patient/treatment-program-instances/[instanceId]/items/[itemId]/progress/test-attempt',
      e,
      {
        fallbackCode: 'progress_test_attempt_failed',
        fallbackStatus: 500,
