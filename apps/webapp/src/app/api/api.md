...
- **admin/media/** — библиотека файлов CMS (`GET /api/admin/media`) с фильтрацией/сортировкой; удаление (`DELETE /api/admin/media/[id]`) с precheck использования в `content_pages` и подтверждением `confirmUsed=true`.
