...
async function fetchWithRecoveryTimeout(
...
async function ensureMessengerMiniAppWebappSessionImpl(router: {
  refresh: () => void;
}): Promise<void> {
...
export async function ensureMessengerMiniAppWebappSession(router: {
  refresh: () => void;
}): Promise<void> {
