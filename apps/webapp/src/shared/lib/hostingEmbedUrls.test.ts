...
describe('toYoutubeEmbedSrc', () => {
  ...
  it('normalizes existing embed URL to https', () => {
    expect(toYoutubeEmbedSrc('http://www.youtube.com/embed/xyz')).toMatch(
...
describe('toRutubeEmbedSrc', () => {
  ...
  it('maps /shorts/{id}', () => {
    expect(toRutubeEmbedSrc('https://rutube.ru/shorts/shortId')).toBe(
      'https://rutube.ru/play/embed/shortId',
    );
  });
...
describe('toYoutubeOrRutubeEmbedSrc', () => {
  it('prefers youtube when youtube matches', () => {
    expect(toYoutubeOrRutubeEmbedSrc('https://www.youtube.com/watch?v=x')).toContain(
      'youtube.com/embed',
    );
  });

  it('falls back to rutube', () => {
    expect(toYoutubeOrRutubeEmbedSrc('https://rutube.ru/video/z')).toContain(
      'rutube.ru/play/embed/z',
    );
  });
});
