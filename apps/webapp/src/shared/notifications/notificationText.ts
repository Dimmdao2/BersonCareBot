...
export const notificationText = {
  ...
  /**
   * Отдельный текст, потому что «повторите попытку» здесь — ложь: повтор не поможет никогда,
   * пока у клиники нет публичного адреса. Текст называет действие, а не отказ.
   */
  doctorInvitePatientOriginMissing:
    'У клиники ещё нет публичного адреса, а ссылка для пациента ведёт именно на него. Задайте адрес в «Настройки» → «Публичный адрес».',
