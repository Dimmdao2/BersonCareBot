...
describe('getDoctorScreenTitle', () => {
  ...
  it('returns content sections titles', () => {
    ...
    expect(getDoctorScreenTitle('/app/doctor/content/sections/edit/warmups')).toBe(
  ...
  it('returns treatment block library titles', () => {
    ...
    expect(getDoctorScreenTitle('/app/doctor/recommendations/abc')).toBe(
      'Редактирование рекомендации',
    );
    expect(getDoctorScreenTitle('/app/doctor/treatment-program-templates')).toBe(
      'Шаблоны программ',
    );
    expect(getDoctorScreenTitle('/app/doctor/treatment-program-templates/new')).toBe(
      'Новый шаблон программы',
    );
    expect(getDoctorScreenTitle('/app/doctor/treatment-program-templates/abc')).toBe(
