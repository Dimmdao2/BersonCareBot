 ...
 *
 * Приклеивается ТОЛЬКО когда тулбар есть. Правило 11.09 сказано про тулбар — «толбар просто оторвался от
 * шапки», — а не про любой первый блок страницы. У «Упражнений» тулбара нет вовсе (поиск, регионы, типы и
 * «Создать» стоят в самой шапке), и приклеивание съедало межблочный зазор shell: карточка каталога и правая
 * форма упирались в шапку без единого пикселя (владелец 15.09: «в упражнениях тоже»). Из семи каталогов
 * тулбара нет только у этого, остальные шесть приклеены как раньше.
 */
  ...
  return (
    <div
      className={cn(
        ...
        toolbar ? DOCTOR_DESKTOP_ATTACH_TO_PAGE_HEADER_CLASS : null,
