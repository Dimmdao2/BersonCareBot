...
// --- Hooks ---
import { useComposedRef } from "@/shared/ui/doctor/tiptap/hooks/use-composed-ref"

// --- Icons ---
import { ArrowRightIcon } from "@/shared/ui/doctor/tiptap/icons/arrow-right-icon"
import { CaseSensitiveIcon } from "@/shared/ui/doctor/tiptap/icons/case-sensitive-icon"
import { ChevronDownIcon } from "@/shared/ui/doctor/tiptap/icons/chevron-down-icon"
import { ChevronUpIcon } from "@/shared/ui/doctor/tiptap/icons/chevron-up-icon"
import { CloseIcon } from "@/shared/ui/doctor/tiptap/icons/close-icon"
import { ExternalLinkIcon } from "@/shared/ui/doctor/tiptap/icons/external-link-icon"
import { SearchIcon } from "@/shared/ui/doctor/tiptap/icons/search-icon"
import { WholeWordIcon } from "@/shared/ui/doctor/tiptap/icons/whole-word-icon"

// --- Lib ---
import { cn } from "@/shared/ui/doctor/tiptap/lib/tiptap-utils"

// --- Tiptap UI ---
import type { UseSearchAndReplaceConfig } from "@/shared/ui/doctor/tiptap/ui/search-and-replace"
import {
...
// --- UI Primitives ---
import type { ButtonProps } from "@/shared/ui/doctor/tiptap/primitives/button"
import { Button } from "@/shared/ui/doctor/tiptap/primitives/button"
import { ButtonGroup } from "@/shared/ui/doctor/tiptap/primitives/button-group"
import {
  Card,
  CardBody,
  CardFooter,
  CardHeader,
} from "@/shared/ui/doctor/tiptap/primitives/card"
import {
  InputGroup,
  InputGroupAddon,
  InputGroupInput,
} from "@/shared/ui/doctor/tiptap/primitives/input-group"
import { Separator } from "@/shared/ui/doctor/tiptap/primitives/separator"
import { Switch } from "@/shared/ui/doctor/tiptap/primitives/switch"

// --- Styles ---
import "@/shared/ui/doctor/tiptap/ui/search-and-replace/search-and-replace.scss"
...
const REGEX_SEARCH_EXAMPLES = [
  { label: "Любая буква в середине:", pattern: "к.т" },
  { label: "Любое из слов:", pattern: "кот|текст" },
  { label: "К в любом регистре:", pattern: "[Кк]от" },
]
            ...
            <div className="tiptap-search-replace-options">
              ...
              >
                <CaseSensitiveIcon
                  ...
                  aria-hidden="true"
                />
                <span className="tiptap-button-text">Учитывать регистр</span>
              </Button>
              ...
              >
                <WholeWordIcon
                  ...
                  aria-hidden="true"
                />
                <span className="tiptap-button-text">Только целые слова</span>
              </Button>
            </div>
          </div>
                ...
                <div className="tiptap-search-replace-regex-help-section">
                  ...
                  >
                    {REGEX_REPLACE_EXAMPLES.map(({ pattern, replacement }) => (
                      ...
                      >
                        <code>{pattern}</code> → <code>{replacement}</code>
                      </RegexExampleButton>
                    ))}
                  </ButtonGroup>
          ...
          <ButtonGroup className="button-group" orientation="horizontal">
            <ButtonGroup>
              <Button
                ...
                disabled={!canReplace}
                aria-label="Заменить текущее совпадение"
