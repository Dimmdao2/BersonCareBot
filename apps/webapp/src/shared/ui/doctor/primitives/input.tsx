...
export const inputFieldSurfaceClassName = cn(
  "box-border h-[32px] w-full min-w-0 rounded-md border border-input bg-transparent px-3 py-1 text-base leading-5 text-foreground transition-colors outline-none md:text-sm",
