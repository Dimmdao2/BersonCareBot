...
vi.mock('@/shared/ui/doctor/media/DoctorMediaPlaybackVideo', () => ({
  DoctorMediaPlaybackVideo: () => <div data-testid="mock-patient-video" />,
}));
...
describe('MarkdownContent', () => {
  ...
  it('renders youtube watch links as iframe embed', () => {
    render(
      <MarkdownContent text="[v](https://www.youtube.com/watch?v=testVid)" bodyFormat="markdown" />,
    );
  ...
  it('renders rutube video links as iframe embed', () => {
    render(
      <MarkdownContent text="[r](https://rutube.ru/video/rutubeClip/)" bodyFormat="markdown" />,
    );
    const iframe = document.querySelector('iframe');
