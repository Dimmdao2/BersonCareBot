...
export const doctorSectionTabBaseClass =
  'inline-flex shrink-0 items-center gap-1.5 rounded-[var(--doctor-control-radius,24px)] px-2.5 py-1.5 text-sm font-medium whitespace-nowrap transition-colors';
