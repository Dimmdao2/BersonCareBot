...
export const patientButtonSuccessClass = cn(
  "inline-flex min-h-11 w-full min-w-0 items-center justify-center gap-2 rounded-2xl px-4 text-base font-bold text-white transition-colors sm:min-h-12",
...
export const patientButtonSecondaryClass = cn(
  "inline-flex min-h-10 w-full min-w-0 items-center justify-center gap-2 rounded-2xl border border-[var(--patient-border)] bg-[var(--patient-card-bg)] px-4 text-sm font-semibold text-[var(--patient-text-primary)] transition-colors",
...
export const patientButtonGhostLinkClass = cn(
  "inline-flex min-h-10 min-w-0 items-center justify-center gap-2 rounded-xl px-3 text-sm font-semibold text-[var(--patient-color-primary)] transition-colors",
...
export const patientButtonDangerOutlineClass = cn(
  "inline-flex min-h-10 w-full min-w-0 items-center justify-center gap-2 rounded-xl border border-[var(--patient-color-danger)] bg-[var(--patient-card-bg)] px-4 text-sm font-bold text-[#dc2626] transition-colors",
...
export const patientButtonWarningOutlineClass = cn(
  "inline-flex min-h-10 w-full min-w-0 items-center justify-center gap-2 rounded-xl border border-[#fde68a] bg-[#fffbeb] px-4 text-sm font-bold text-[#d97706] transition-colors",
