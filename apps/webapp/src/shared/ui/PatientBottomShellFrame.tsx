...
import { PatientShellTopChrome } from "@/shared/ui/PatientShellTopChrome";
...
export function PatientBottomShellFrame({
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "shrink-0 patient-mobile:pt-[var(--patient-header-bar-height,var(--patient-header-bar-chrome-fallback))]",
