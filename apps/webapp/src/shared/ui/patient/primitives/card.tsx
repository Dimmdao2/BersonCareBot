...
function CardHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'group/card-header @container/card-header grid auto-rows-min items-start gap-1 rounded-t-xl px-4 has-data-[slot=card-action]:grid-cols-[1fr_auto] has-data-[slot=card-description]:grid-rows-[auto_auto] [.border-b]:pb-4 group-data-[variant=compact]/card:px-3 group-data-[variant=compact]/card:[.border-b]:pb-3',
        className,
      )}
      {...props}
    />
...
function CardContent({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('px-4 group-data-[variant=compact]/card:px-3', className)}
      {...props}
    />
  );
}
...
function CardFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        'flex items-center rounded-b-xl border-t bg-muted/50 p-4 group-data-[variant=compact]/card:p-3',
        className,
      )}
      {...props}
    />
