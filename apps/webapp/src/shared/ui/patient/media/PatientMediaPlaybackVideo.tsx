/**
 * Единый пациентский видеоплеер: источник задаёт только ответ `GET /api/media/[id]/playback`.
...
} from '@/shared/ui/patient/media/patientHlsQuality';
...
function patientPlaybackDiag(payload: {
  event: string;
  mediaId: string;
  delivery?: string;
  detail?: string;
