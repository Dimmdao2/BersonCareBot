...
const cards: ChannelCard[] = [
  { code: "telegram", title: "Telegram", openUrl: "https://t.me/test", isLinked: false, isImplemented: true, isEnabledForMessages: true, isEnabledForNotifications: true },
  { code: "max", title: "MAX", openUrl: "https://max.ru/test", isLinked: false, isImplemented: true, isEnabledForMessages: true, isEnabledForNotifications: true },
];
