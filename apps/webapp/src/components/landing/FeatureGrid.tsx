...
import { BookOpen, CalendarDays, ClipboardList, FileHeart, MessageCircle, UserRound } from "lucide-react";
      ...
      <div className={landingContainer}>
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => {
            ...
            return (
              <article key={feature.title} className="rounded-[20px] border border-[#E1E7EE] bg-white p-6 transition hover:-translate-y-0.5 hover:border-[#B8C9DE]">
