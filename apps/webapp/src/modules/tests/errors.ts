...
export function isClinicalTestArchiveNotFoundError(
  e: unknown,
): e is ClinicalTestArchiveNotFoundError {
...
export function isClinicalTestArchiveAlreadyArchivedError(
  e: unknown,
): e is ClinicalTestArchiveAlreadyArchivedError {
...
export function isClinicalTestUnarchiveNotArchivedError(
  e: unknown,
): e is ClinicalTestUnarchiveNotArchivedError {
...
export function isTestSetUsageConfirmationRequiredError(
  e: unknown,
): e is TestSetUsageConfirmationRequiredError {
...
export function isTestSetArchiveAlreadyArchivedError(
  e: unknown,
): e is TestSetArchiveAlreadyArchivedError {
...
export function isTestSetUnarchiveNotArchivedError(
  e: unknown,
): e is TestSetUnarchiveNotArchivedError {
