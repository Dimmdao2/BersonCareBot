 ...
 *
 * Короткое описание — обычный текст, он же строка превью на визитке. Полное — форматированный материал,
...
export type ClinicPublicCard = {
  ...
  description: string | null;
  /** Полное описание — versioned Tiptap JSON; его медиа лежат в том же наборе `media`. */
  fullDescriptionMarkdown: string | null;
