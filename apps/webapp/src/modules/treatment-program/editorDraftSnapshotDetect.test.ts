...
describe('editorDraftSnapshotDetect', () => {
  it('flags exercise draft preview snapshot', () => {
    expect(
      exerciseInstanceSnapshotNeedsCatalogRebuild({
        ...
        media: [
          {
            mediaUrl: '/api/media/7e07b4a9-51b9-476c-a532-74d54f9094a7/preview/sm',
            mediaType: 'image',
          },
        ],
      }),
  ...
  it('flags recommendation with preview-only mediaUrl', () => {
    expect(
      catalogMediaArrayHasPreviewOnlyUrls([
        {
          mediaUrl: '/api/media/aaaaaaaa-aaaa-4aaa-8aaa-aaaaaaaaaaaa/preview/sm',
          mediaType: 'image',
        },
      ]),
    ).toBe(true);
        ...
        tests: [
          {
            ...
            media: [
              {
                mediaUrl: '/api/media/bbbbbbbb-bbbb-4bbb-8bbb-bbbbbbbbbbbb/preview/sm',
                mediaType: 'image',
              },
            ],
          },
