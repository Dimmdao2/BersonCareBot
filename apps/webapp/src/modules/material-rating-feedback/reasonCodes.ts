...
export type MaterialRatingFeedbackReasonCode =
  (typeof MATERIAL_RATING_FEEDBACK_REASON_CODES)[number];

export const MATERIAL_RATING_FEEDBACK_REASON_LABELS: Record<
  MaterialRatingFeedbackReasonCode,
  string
> = {
...
export function isMaterialRatingFeedbackReasonCode(
  value: string,
): value is MaterialRatingFeedbackReasonCode {
