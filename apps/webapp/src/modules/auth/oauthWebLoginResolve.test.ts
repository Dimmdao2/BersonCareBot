...
describe('resolveUserIdForWebOAuthLogin', () => {
  beforeEach(() => {
    ...
    vi.mocked(oauthResolveMock.resolveCanonicalUserId)
      .mockReset()
    ...
    vi.mocked(oauthResolveMock.createOAuthPlatformUser)
      .mockReset()
      .mockResolvedValue('oauth-only-id');
    vi.mocked(oauthResolveMock.upsertOAuthBinding)
      .mockReset()
