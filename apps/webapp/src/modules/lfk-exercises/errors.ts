...
export function isExerciseArchiveAlreadyArchivedError(
  e: unknown,
): e is ExerciseArchiveAlreadyArchivedError {
...
export function isExerciseUnarchiveNotArchivedError(
  e: unknown,
): e is ExerciseUnarchiveNotArchivedError {
