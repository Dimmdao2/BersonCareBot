...
const restricted = (
  ...
  scope, storage: "restricted", legacySource: "system_settings", ownership, audience: "server",
  valueContract, defaultValue, clientSerialization, safeProjection,
} as const);
...
const runtime = (
  ...
  scope, storage: "runtime", legacySource: "system_settings", ownership, audience,
  valueContract, defaultValue, clientSerialization: audience === "server" ? "none" : "raw",
} as const);
...
export const SYSTEM_SETTING_REGISTRY = {
  ...
  patient_home_daily_practice_target: runtime("admin", "per_org", "authenticated_client", "integer", "3"),
  patient_default_promo_treatment_program_template_id: runtime("admin", "per_org", "authenticated_client", "uuid", "absent"),
  patient_home_daily_warmup_rotation_enabled: runtime("admin", "per_org", "authenticated_client", "boolean", "false"),
  patient_home_daily_warmup_rotation_times: runtime("admin", "per_org", "authenticated_client", "structured", "[]"),
  ...
  video_playback_api_enabled: runtime("admin", "global", "authenticated_client", "boolean", "false"),
  ...
  booking_doctor_appointments_read_source: runtime("admin", "global", "server", "string", "rubitime_legacy"),
  ...
  patient_home_daily_warmup_repeat_cooldown_minutes: runtime("admin", "per_org", "authenticated_client", "integer", "60"),
  patient_treatment_plan_item_done_repeat_cooldown_minutes: runtime("admin", "per_org", "authenticated_client", "integer", "60"),
  patient_home_warmup_skip_to_next_available_enabled: runtime("admin", "global", "server", "boolean", "false"),
  ...
  "notif_template:cancelled:patient": runtime("admin", "per_org", "server", "string", "hardcoded fallback"),
  "notif_template:cancelled:doctor": runtime("admin", "per_org", "server", "string", "hardcoded fallback"),
  "notif_template:rescheduled:patient": runtime("admin", "per_org", "server", "string", "hardcoded fallback"),
  "notif_template:rescheduled:doctor": runtime("admin", "per_org", "server", "string", "hardcoded fallback"),
  ...
  apple_oauth_key_id: restricted("admin", "global", "secret_envelope", "absent", "derived", "oauth_apple_enabled"),
  apple_oauth_private_key: restricted("admin", "global", "secret_envelope", "absent", "derived", "oauth_apple_enabled"),
  apple_oauth_redirect_uri: restricted("admin", "global", "url", "absent", "derived", "oauth_apple_enabled"),
