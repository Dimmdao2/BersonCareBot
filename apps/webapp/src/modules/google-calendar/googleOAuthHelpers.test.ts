...
describe('exchangeGoogleCode', () => {
  ...
  it('throws on HTTP error', async () => {
    ...
    await expect(exchangeGoogleCode('bad', opts)).rejects.toThrow(
  ...
  it('throws when access_token is missing in response', async () => {
    ...
    await expect(exchangeGoogleCode('code', opts)).rejects.toThrow(
...
describe('refreshGoogleAccessToken', () => {
  ...
  it('throws when access_token is missing', async () => {
    ...
    await expect(refreshGoogleAccessToken(opts)).rejects.toThrow(
      'google_refresh_missing_access_token',
    );
  });
});
...
describe('fetchGoogleCalendarList', () => {
  ...
  it('throws on 401', async () => {
    ...
    await expect(fetchGoogleCalendarList('tok')).rejects.toThrow(
      'google_calendar_list_failed: 401',
    );
  });
});
