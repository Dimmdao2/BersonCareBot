...
describe('formatPatientPackageLongLabel', () => {
  it('formats membership number and sold date for package cards', () => {
    expect(formatPatientPackageLongLabel(1, '2026-06-01T00:00:00.000Z')).toBe(
      'аб #001 от 01.06.2026',
    );
  ...
  it('falls back without inventing a long number', () => {
    expect(formatPatientPackageLongLabel(null, '2026-06-01T00:00:00.000Z')).toBe(
      'аб #— от 01.06.2026',
    );
