...
export const ADMIN_WEB_PUSH_ONLY_REMINDER_TICK_STALE_SEC = 5 * 60;

export type WebPushOnlyReminderTickHealthSignals = {
...
/**
 * Статус cron `POST /api/internal/reminders/web-push-only/tick` для admin system-health.
 */
