 ...
 * и уже лежащие в библиотеке файлы. Мерится при этом НЕ загруженный файл, а наш стандартный
 * рендишн (коррекция 14.09.2026, см. `app-layer/media/orgAppIconRenditions.ts`): его короткая
 * сторона ограничена `STANDARD_IMAGE_SHORT_SIDE`, поэтому верхняя граница здесь почти никогда не
 * срабатывает — реальная работа этой проверки — нижняя граница.
 */
