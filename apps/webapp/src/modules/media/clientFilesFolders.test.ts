...
describe('clientFilesFolders', () => {
  ...
  it('adds suffix only as fallback on name collision', () => {
    expect(
      clientPatientFolderFallbackName('Иван Петров', 'abcd1234-0000-4000-8000-000000000001', null),
    ).toBe('Иван Петров · abcd1234');
  });
  ...
  describe('clientPatientFolderFioName', () => {
    ...
    it('trims whitespace from each part', () => {
      expect(clientPatientFolderFioName('  Иванов  ', ' Иван ', ' Иванович ')).toBe(
