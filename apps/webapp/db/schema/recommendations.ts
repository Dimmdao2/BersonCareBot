...
export const recommendations = pgTable(
  ...
  (table) => [
    index('idx_recommendations_organization_id').using(
      'btree',
    ...
    index('idx_recommendations_domain').using(
      'btree',
      table.domain.asc().nullsLast().op('text_ops'),
    ),
    index('idx_recommendations_body_region').using(
      'btree',
...
export const recommendationRegions = pgTable(
  ...
  (table) => [
    primaryKey({
      columns: [table.recommendationId, table.bodyRegionId],
      name: 'recommendation_regions_pkey',
    }),
    index('idx_recommendation_regions_organization_id').using(
      'btree',
      table.organizationId.asc().nullsLast().op('uuid_ops'),
    ),
    foreignKey({
