...
export const clinicalTests = pgTable(
  ...
  (table) => [
    index('idx_tests_organization_id').using(
      'btree',
    ...
    index('idx_tests_assessment_kind').using(
      'btree',
      table.assessmentKind.asc().nullsLast().op('text_ops'),
    ),
    foreignKey({
...
export const clinicalTestRegions = pgTable(
  ...
  (table) => [
    primaryKey({
      columns: [table.clinicalTestId, table.bodyRegionId],
      name: 'clinical_test_regions_pkey',
    }),
    index('idx_clinical_test_regions_organization_id').using(
      'btree',
      table.organizationId.asc().nullsLast().op('uuid_ops'),
    ),
    foreignKey({
...
export const testSets = pgTable(
  ...
  (table) => [
    ...
    index('idx_test_sets_organization_id').using(
      'btree',
      table.organizationId.asc().nullsLast().op('uuid_ops'),
    ),
    index('idx_test_sets_archived').using(
      'btree',
...
export const testSetItems = pgTable(
  ...
  (table) => [
    index('idx_test_set_items_organization_id').using(
      'btree',
      table.organizationId.asc().nullsLast().op('uuid_ops'),
    ),
