...
export const beBookingFormFields = pgTable(
  ...
  (table) => [
    index('idx_be_booking_form_fields_org').using(
      'btree',
...
export const beBookingFormSubmissions = pgTable(
  ...
  (table) => [
    index('idx_be_booking_form_submissions_appt').using(
      'btree',
...
export const beWorkingHours = pgTable(
  ...
  (table) => [
    ...
    check(
      'be_working_hours_minutes_check',
...
export const beScheduleTemplates = pgTable(
  ...
  (table) => [
    index('idx_be_schedule_templates_org').using(
      'btree',
      table.organizationId.asc().nullsLast().op('uuid_ops'),
    ),
    foreignKey({
