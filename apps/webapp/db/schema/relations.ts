...
export const platformUsersRelations = relations(platformUsers, ({ one, many }) => ({
  ...
  platformUserContacts: many(platformUserContacts),
}));

export const platformUserContactsRelations = relations(platformUserContacts, ({ one }) => ({
  platformUser: one(platformUsers, {
    fields: [platformUserContacts.platformUserId],
    references: [platformUsers.id],
  }),
}));
...
export const contentAccessGrantsWebappRelations = relations(
  contentAccessGrantsWebapp,
  ({ one }) => ({
    platformUser: one(platformUsers, {
...
export const lfkComplexTemplateExercisesRelations = relations(
  lfkComplexTemplateExercises,
  ({ one }) => ({
...
export const onlineIntakeStatusHistoryRelations = relations(
  onlineIntakeStatusHistory,
  ({ one }) => ({
    platformUser: one(platformUsers, {
...
export const treatmentProgramTemplatesRelations = relations(
  treatmentProgramTemplates,
  ({ one, many }) => ({
    platformUser: one(platformUsers, {
...
export const treatmentProgramInstancesRelations = relations(
  treatmentProgramInstances,
  ({ one, many }) => ({
    template: one(treatmentProgramTemplates, {
...
export const treatmentProgramTestResultsRelations = relations(
  treatmentProgramTestResults,
  ({ one }) => ({
