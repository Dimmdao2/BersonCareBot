...
export const SAAS_BILLING_LIFECYCLE_VALUES = [
  "active",
  "grace",
  "read_only",
  "blocked",
...
export const saasBillingSubscriptions = pgTable(
  ...
  (table) => [
    unique("saas_billing_subscriptions_org_source_uidx").on(
      table.organizationId,
      table.source,
    ),
    unique("saas_billing_subscriptions_id_organization_uidx").on(
      table.id,
      table.organizationId,
    ),
    index("idx_saas_billing_subscriptions_org_status").on(
      table.organizationId,
      table.status,
    ),
...
export const saasBillingInvoices = pgTable(
  ...
  (table) => [
    ...
    index("idx_saas_billing_invoices_org_created").on(
      table.organizationId,
      table.createdAt,
    ),
...
export const saasBillingProviderEvents = pgTable(
  ...
  (table) => [
    ...
    index("idx_saas_billing_provider_events_org_created").on(
      table.organizationId,
      table.createdAt,
    ),
