-- TEMPORARY LOCAL MIGRATION NUMBER 0277 — the lead assigns the final number at merge.
-- #1069 item 3.1c: one lifecycle door for webapp and integrator.
--
-- CREATE OR REPLACE plus re-applied owner/ACL/table grants makes this safe both when 0276 ran
-- before the door existed and when an environment already received the previously appended door.
