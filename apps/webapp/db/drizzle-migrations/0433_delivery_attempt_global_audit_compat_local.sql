...
-- Clinic delivery carries organization_id; genuine global/pre-login audit remains honestly NULL.
...
COMMENT ON FUNCTION app.record_operational_delivery_attempt_audit(
  ...
  'Exact integrator-port capability: clinic delivery is tenant-attributed; genuine global/pre-login audit remains NULL.';
