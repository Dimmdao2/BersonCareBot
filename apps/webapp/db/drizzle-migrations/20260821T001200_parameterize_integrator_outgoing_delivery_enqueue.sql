...
BEGIN
  PERFORM app.require_accepted_context(
    ...
    'app.enqueue_integrator_outgoing_delivery(text,text,text,text,integer,timestamp with time zone,uuid)'::regprocedure
  );
...
-- BCB-MIGRATION-OWNER: app_seam_delivery_scope_owner
DROP FUNCTION IF EXISTS app.enqueue_integrator_inbound_reply(text,text,text,integer,uuid);
