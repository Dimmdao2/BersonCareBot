...
export type MediaWorkerRuntimeBooleanKey = 'video_hls_pipeline_enabled' | 'video_watermark_enabled';

export type MediaWorkerRuntimeStringKey = 'error_tracking_enabled' | 'error_tracking_dsn';
