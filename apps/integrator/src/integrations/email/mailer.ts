 ...
 *
 * Dev safety is enforced before this network boundary by the EmailDeliveryAdapter's single check
 * of the resolved SMTP host. All email paths route through dispatchPort → EmailDeliveryAdapter →
 * sendMail (S8/S9/S10).
 */
