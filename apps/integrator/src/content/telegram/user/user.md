...
Сценарии и шаблоны для обычного пользователя в Telegram: меню, запись на приём, кабинет, вопросы админу, уведомления. scripts.json, templates.json, menu.json, replyMenu.json.
