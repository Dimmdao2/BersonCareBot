...
Архитектура и потоки: `ARCHITECTURE.md`. Оглавление документации: `docs/README.md`. В папках внутри `src/` и `webapp/src/` лежат файлы `имя_папки.md` с кратким назначением модуля; при изменении модуля их стоит дополнять.
